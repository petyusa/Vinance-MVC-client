...
//! moment.js locale configuration
hooks.defineLocale("ca",{months:{standalone:"gener_febrer_març_abril_maig_juny_juliol_agost_setembre_octubre_novembre_desembre".split("_"),format:"de gener_de febrer_de març_d'abril_de maig_de juny_de juliol_d'agost_de setembre_d'octubre_de novembre_de desembre".split("_"),isFormat:/D[oD]?(\s)+MMMM/},monthsShort:"gen._febr._març_abr._maig_juny_jul._ag._set._oct._nov._des.".split("_"),monthsParseExact:!0,weekdays:"diumenge_dilluns_dimarts_dimecres_dijous_divendres_dissabte".split("_"),weekdaysShort:"dg._dl._dt._dc._dj._dv._ds.".split("_"),weekdaysMin:"dg_dl_dt_dc_dj_dv_ds".split("_"),weekdaysParseExact:!0,longDateFormat:{LT:"H:mm",LTS:"H:mm:ss",L:"DD/MM/YYYY",LL:"D MMMM [de] YYYY",ll:"D MMM YYYY",LLL:"D MMMM [de] YYYY [a les] H:mm",lll:"D MMM YYYY, H:mm",LLLL:"dddd D MMMM [de] YYYY [a les] H:mm",llll:"ddd D MMM YYYY, H:mm"},calendar:{sameDay:function(){return"[avui a "+(this.hours()!==1?"les":"la")+"] LT"},nextDay:function(){return"[demà a "+(this.hours()!==1?"les":"la")+"] LT"},nextWeek:function(){return"dddd [a "+(this.hours()!==1?"les":"la")+"] LT"},lastDay:function(){return"[ahir a "+(this.hours()!==1?"les":"la")+"] LT"},lastWeek:function(){return"[el] dddd [passat a "+(this.hours()!==1?"les":"la")+"] LT"},sameElse:"L"},relativeTime:{future:"d'aquí %s",past:"fa %s",s:"uns segons",ss:"%d segons",m:"un minut",mm:"%d minuts",h:"una hora",hh:"%d hores",d:"un dia",dd:"%d dies",M:"un mes",MM:"%d mesos",y:"un any",yy:"%d anys"},dayOfMonthOrdinalParse:/\d{1,2}(r|n|t|è|a)/,ordinal:function(number,period){var output=number===1?"r":number===2?"n":number===3?"r":number===4?"t":"è";return(period==="w"||period==="W")&&(output="a"),number+output},week:{dow:1,doy:4}});
//! moment.js locale configuration
months$3="leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec".split("_");monthsShort="led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro".split("_");hooks.defineLocale("cs",{months:months$3,monthsShort:monthsShort,monthsParse:function(months,monthsShort){for(var _monthsParse=[],i=0;i<12;i++)_monthsParse[i]=new RegExp("^"+months[i]+"$|^"+monthsShort[i]+"$","i");return _monthsParse}(months$3,monthsShort),shortMonthsParse:function(monthsShort){for(var _shortMonthsParse=[],i=0;i<12;i++)_shortMonthsParse[i]=new RegExp("^"+monthsShort[i]+"$","i");return _shortMonthsParse}(monthsShort),longMonthsParse:function(months){for(var _longMonthsParse=[],i=0;i<12;i++)_longMonthsParse[i]=new RegExp("^"+months[i]+"$","i");return _longMonthsParse}(months$3),weekdays:"neděle_pondělí_úterý_středa_čtvrtek_pátek_sobota".split("_"),weekdaysShort:"ne_po_út_st_čt_pá_so".split("_"),weekdaysMin:"ne_po_út_st_čt_pá_so".split("_"),longDateFormat:{LT:"H:mm",LTS:"H:mm:ss",L:"DD.MM.YYYY",LL:"D. MMMM YYYY",LLL:"D. MMMM YYYY H:mm",LLLL:"dddd D. MMMM YYYY H:mm",l:"D. M. YYYY"},calendar:{sameDay:"[dnes v] LT",nextDay:"[zítra v] LT",nextWeek:function(){switch(this.day()){case 0:return"[v neděli v] LT";case 1:case 2:return"[v] dddd [v] LT";case 3:return"[ve středu v] LT";case 4:return"[ve čtvrtek v] LT";case 5:return"[v pátek v] LT";case 6:return"[v sobotu v] LT"}},lastDay:"[včera v] LT",lastWeek:function(){switch(this.day()){case 0:return"[minulou neděli v] LT";case 1:case 2:return"[minulé] dddd [v] LT";case 3:return"[minulou středu v] LT";case 4:case 5:return"[minulý] dddd [v] LT";case 6:return"[minulou sobotu v] LT"}},sameElse:"L"},relativeTime:{future:"za %s",past:"před %s",s:translate$1,ss:translate$1,m:translate$1,mm:translate$1,h:translate$1,hh:translate$1,d:translate$1,dd:translate$1,M:translate$1,MM:translate$1,y:translate$1,yy:translate$1},dayOfMonthOrdinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});
//! moment.js locale configuration
...
//! moment.js locale configuration
hooks.defineLocale("cy",{months:"Ionawr_Chwefror_Mawrth_Ebrill_Mai_Mehefin_Gorffennaf_Awst_Medi_Hydref_Tachwedd_Rhagfyr".split("_"),monthsShort:"Ion_Chwe_Maw_Ebr_Mai_Meh_Gor_Aws_Med_Hyd_Tach_Rhag".split("_"),weekdays:"Dydd Sul_Dydd Llun_Dydd Mawrth_Dydd Mercher_Dydd Iau_Dydd Gwener_Dydd Sadwrn".split("_"),weekdaysShort:"Sul_Llun_Maw_Mer_Iau_Gwe_Sad".split("_"),weekdaysMin:"Su_Ll_Ma_Me_Ia_Gw_Sa".split("_"),weekdaysParseExact:!0,longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd, D MMMM YYYY HH:mm"},calendar:{sameDay:"[Heddiw am] LT",nextDay:"[Yfory am] LT",nextWeek:"dddd [am] LT",lastDay:"[Ddoe am] LT",lastWeek:"dddd [diwethaf am] LT",sameElse:"L"},relativeTime:{future:"mewn %s",past:"%s yn ôl",s:"ychydig eiliadau",ss:"%d eiliad",m:"munud",mm:"%d munud",h:"awr",hh:"%d awr",d:"diwrnod",dd:"%d diwrnod",M:"mis",MM:"%d mis",y:"blwyddyn",yy:"%d flynedd"},dayOfMonthOrdinalParse:/\d{1,2}(fed|ain|af|il|ydd|ed|eg)/,ordinal:function(number){var b=number,output="";return b>20?output=b===40||b===50||b===60||b===80||b===100?"fed":"ain":b>0&&(output=["","af","il","ydd","ydd","ed","ed","ed","fed","fed","fed","eg","fed","eg","eg","fed","eg","eg","fed","eg","fed"][b]),number+output},week:{dow:1,doy:4}});
//! moment.js locale configuration
...
//! moment.js locale configuration
hooks.defineLocale("de-ch",{months:"Januar_Februar_März_April_Mai_Juni_Juli_August_September_Oktober_November_Dezember".split("_"),monthsShort:"Jan._Feb._März_Apr._Mai_Juni_Juli_Aug._Sep._Okt._Nov._Dez.".split("_"),monthsParseExact:!0,weekdays:"Sonntag_Montag_Dienstag_Mittwoch_Donnerstag_Freitag_Samstag".split("_"),weekdaysShort:"So_Mo_Di_Mi_Do_Fr_Sa".split("_"),weekdaysMin:"So_Mo_Di_Mi_Do_Fr_Sa".split("_"),weekdaysParseExact:!0,longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY",LL:"D. MMMM YYYY",LLL:"D. MMMM YYYY HH:mm",LLLL:"dddd, D. MMMM YYYY HH:mm"},calendar:{sameDay:"[heute um] LT [Uhr]",sameElse:"L",nextDay:"[morgen um] LT [Uhr]",nextWeek:"dddd [um] LT [Uhr]",lastDay:"[gestern um] LT [Uhr]",lastWeek:"[letzten] dddd [um] LT [Uhr]"},relativeTime:{future:"in %s",past:"vor %s",s:"ein paar Sekunden",ss:"%d Sekunden",m:processRelativeTime$1,mm:"%d Minuten",h:processRelativeTime$1,hh:"%d Stunden",d:processRelativeTime$1,dd:processRelativeTime$1,M:processRelativeTime$1,MM:processRelativeTime$1,y:processRelativeTime$1,yy:processRelativeTime$1},dayOfMonthOrdinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});
//! moment.js locale configuration
...
//! moment.js locale configuration
symbolMap$7={"1":"१","2":"२","3":"३","4":"४","5":"५","6":"६","7":"७","8":"८","9":"९","0":"०"};numberMap$6={"१":"1","२":"2","३":"3","४":"4","५":"5","६":"6","७":"7","८":"8","९":"9","०":"0"};hooks.defineLocale("hi",{months:"जनवरी_फ़रवरी_मार्च_अप्रैल_मई_जून_जुलाई_अगस्त_सितम्बर_अक्टूबर_नवम्बर_दिसम्बर".split("_"),monthsShort:"जन._फ़र._मार्च_अप्रै._मई_जून_जुल._अग._सित._अक्टू._नव._दिस.".split("_"),monthsParseExact:!0,weekdays:"रविवार_सोमवार_मंगलवार_बुधवार_गुरूवार_शुक्रवार_शनिवार".split("_"),weekdaysShort:"रवि_सोम_मंगल_बुध_गुरू_शुक्र_शनि".split("_"),weekdaysMin:"र_सो_मं_बु_गु_शु_श".split("_"),longDateFormat:{LT:"A h:mm बजे",LTS:"A h:mm:ss बजे",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY, A h:mm बजे",LLLL:"dddd, D MMMM YYYY, A h:mm बजे"},calendar:{sameDay:"[आज] LT",nextDay:"[कल] LT",nextWeek:"dddd, LT",lastDay:"[कल] LT",lastWeek:"[पिछले] dddd, LT",sameElse:"L"},relativeTime:{future:"%s में",past:"%s पहले",s:"कुछ ही क्षण",ss:"%d सेकंड",m:"एक मिनट",mm:"%d मिनट",h:"एक घंटा",hh:"%d घंटे",d:"एक दिन",dd:"%d दिन",M:"एक महीने",MM:"%d महीने",y:"एक वर्ष",yy:"%d वर्ष"},preparse:function(string){return string.replace(/[१२३४५६७८९०]/g,function(match){return numberMap$6[match]})},postformat:function(string){return string.replace(/\d/g,function(match){return symbolMap$7[match]})},meridiemParse:/रात|सुबह|दोपहर|शाम/,meridiemHour:function(hour,meridiem){return(hour===12&&(hour=0),meridiem==="रात")?hour<4?hour:hour+12:meridiem==="सुबह"?hour:meridiem==="दोपहर"?hour>=10?hour:hour+12:meridiem==="शाम"?hour+12:void 0},meridiem:function(hour){return hour<4?"रात":hour<10?"सुबह":hour<17?"दोपहर":hour<20?"शाम":"रात"},week:{dow:0,doy:6}});
//! moment.js locale configuration
...
//! moment.js locale configuration
hooks.defineLocale("ja",{months:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),monthsShort:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),weekdays:"日曜日_月曜日_火曜日_水曜日_木曜日_金曜日_土曜日".split("_"),weekdaysShort:"日_月_火_水_木_金_土".split("_"),weekdaysMin:"日_月_火_水_木_金_土".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY/MM/DD",LL:"YYYY年M月D日",LLL:"YYYY年M月D日 HH:mm",LLLL:"YYYY年M月D日 dddd HH:mm",l:"YYYY/MM/DD",ll:"YYYY年M月D日",lll:"YYYY年M月D日 HH:mm",llll:"YYYY年M月D日(ddd) HH:mm"},meridiemParse:/午前|午後/i,isPM:function(input){return input==="午後"},meridiem:function(hour){return hour<12?"午前":"午後"},calendar:{sameDay:"[今日] LT",nextDay:"[明日] LT",nextWeek:function(now){return now.week()<this.week()?"[来週]dddd LT":"dddd LT"},lastDay:"[昨日] LT",lastWeek:function(now){return this.week()<now.week()?"[先週]dddd LT":"dddd LT"},sameElse:"L"},dayOfMonthOrdinalParse:/\d{1,2}日/,ordinal:function(number,period){switch(period){case"d":case"D":case"DDD":return number+"日";default:return number}},relativeTime:{future:"%s後",past:"%s前",s:"数秒",ss:"%d秒",m:"1分",mm:"%d分",h:"1時間",hh:"%d時間",d:"1日",dd:"%d日",M:"1ヶ月",MM:"%dヶ月",y:"1年",yy:"%d年"}});
//! moment.js locale configuration
hooks.defineLocale("jv",{months:"Januari_Februari_Maret_April_Mei_Juni_Juli_Agustus_September_Oktober_Nopember_Desember".split("_"),monthsShort:"Jan_Feb_Mar_Apr_Mei_Jun_Jul_Ags_Sep_Okt_Nop_Des".split("_"),weekdays:"Minggu_Senen_Seloso_Rebu_Kemis_Jemuwah_Septu".split("_"),weekdaysShort:"Min_Sen_Sel_Reb_Kem_Jem_Sep".split("_"),weekdaysMin:"Mg_Sn_Sl_Rb_Km_Jm_Sp".split("_"),longDateFormat:{LT:"HH.mm",LTS:"HH.mm.ss",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY [pukul] HH.mm",LLLL:"dddd, D MMMM YYYY [pukul] HH.mm"},meridiemParse:/enjing|siyang|sonten|ndalu/,meridiemHour:function(hour,meridiem){return(hour===12&&(hour=0),meridiem==="enjing")?hour:meridiem==="siyang"?hour>=11?hour:hour+12:meridiem==="sonten"||meridiem==="ndalu"?hour+12:void 0},meridiem:function(hours){return hours<11?"enjing":hours<15?"siyang":hours<19?"sonten":"ndalu"},calendar:{sameDay:"[Dinten puniko pukul] LT",nextDay:"[Mbenjang pukul] LT",nextWeek:"dddd [pukul] LT",lastDay:"[Kala wingi pukul] LT",lastWeek:"dddd [kepengker pukul] LT",sameElse:"L"},relativeTime:{future:"wonten ing %s",past:"%s ingkang kepengker",s:"sawetawis detik",ss:"%d detik",m:"setunggal menit",mm:"%d menit",h:"setunggal jam",hh:"%d jam",d:"sedinten",dd:"%d dinten",M:"sewulan",MM:"%d wulan",y:"setaun",yy:"%d taun"},week:{dow:1,doy:7}});
//! moment.js locale configuration
...
//! moment.js locale configuration
suffixes$1={0:"-ші",1:"-ші",2:"-ші",3:"-ші",4:"-ші",5:"-ші",6:"-шы",7:"-ші",8:"-ші",9:"-шы",10:"-шы",20:"-шы",30:"-шы",40:"-шы",50:"-ші",60:"-шы",70:"-ші",80:"-ші",90:"-шы",100:"-ші"};hooks.defineLocale("kk",{months:"қаңтар_ақпан_наурыз_сәуір_мамыр_маусым_шілде_тамыз_қыркүйек_қазан_қараша_желтоқсан".split("_"),monthsShort:"қаң_ақп_нау_сәу_мам_мау_шіл_там_қыр_қаз_қар_жел".split("_"),weekdays:"жексенбі_дүйсенбі_сейсенбі_сәрсенбі_бейсенбі_жұма_сенбі".split("_"),weekdaysShort:"жек_дүй_сей_сәр_бей_жұм_сен".split("_"),weekdaysMin:"жк_дй_сй_ср_бй_жм_сн".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd, D MMMM YYYY HH:mm"},calendar:{sameDay:"[Бүгін сағат] LT",nextDay:"[Ертең сағат] LT",nextWeek:"dddd [сағат] LT",lastDay:"[Кеше сағат] LT",lastWeek:"[Өткен аптаның] dddd [сағат] LT",sameElse:"L"},relativeTime:{future:"%s ішінде",past:"%s бұрын",s:"бірнеше секунд",ss:"%d секунд",m:"бір минут",mm:"%d минут",h:"бір сағат",hh:"%d сағат",d:"бір күн",dd:"%d күн",M:"бір ай",MM:"%d ай",y:"бір жыл",yy:"%d жыл"},dayOfMonthOrdinalParse:/\d{1,2}-(ші|шы)/,ordinal:function(number){var a=number%10,b=number>=100?100:null;return number+(suffixes$1[number]||suffixes$1[a]||suffixes$1[b])},week:{dow:1,doy:7}});
//! moment.js locale configuration
symbolMap$8={"1":"១","2":"២","3":"៣","4":"៤","5":"៥","6":"៦","7":"៧","8":"៨","9":"៩","0":"០"};numberMap$7={"១":"1","២":"2","៣":"3","៤":"4","៥":"5","៦":"6","៧":"7","៨":"8","៩":"9","០":"0"};hooks.defineLocale("km",{months:"មករា_កុម្ភៈ_មីនា_មេសា_ឧសភា_មិថុនា_កក្កដា_សីហា_កញ្ញា_តុលា_វិច្ឆិកា_ធ្នូ".split("_"),monthsShort:"មករា_កុម្ភៈ_មីនា_មេសា_ឧសភា_មិថុនា_កក្កដា_សីហា_កញ្ញា_តុលា_វិច្ឆិកា_ធ្នូ".split("_"),weekdays:"អាទិត្យ_ច័ន្ទ_អង្គារ_ពុធ_ព្រហស្បតិ៍_សុក្រ_សៅរ៍".split("_"),weekdaysShort:"អា_ច_អ_ព_ព្រ_សុ_ស".split("_"),weekdaysMin:"អា_ច_អ_ព_ព្រ_សុ_ស".split("_"),weekdaysParseExact:!0,longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd, D MMMM YYYY HH:mm"},meridiemParse:/ព្រឹក|ល្ងាច/,isPM:function(input){return input==="ល្ងាច"},meridiem:function(hour){return hour<12?"ព្រឹក":"ល្ងាច"},calendar:{sameDay:"[ថ្ងៃនេះ ម៉ោង] LT",nextDay:"[ស្អែក ម៉ោង] LT",nextWeek:"dddd [ម៉ោង] LT",lastDay:"[ម្សិលមិញ ម៉ោង] LT",lastWeek:"dddd [សប្តាហ៍មុន] [ម៉ោង] LT",sameElse:"L"},relativeTime:{future:"%sទៀត",past:"%sមុន",s:"ប៉ុន្មានវិនាទី",ss:"%d វិនាទី",m:"មួយនាទី",mm:"%d នាទី",h:"មួយម៉ោង",hh:"%d ម៉ោង",d:"មួយថ្ងៃ",dd:"%d ថ្ងៃ",M:"មួយខែ",MM:"%d ខែ",y:"មួយឆ្នាំ",yy:"%d ឆ្នាំ"},dayOfMonthOrdinalParse:/ទី\d{1,2}/,ordinal:"ទី%d",preparse:function(string){return string.replace(/[១២៣៤៥៦៧៨៩០]/g,function(match){return numberMap$7[match]})},postformat:function(string){return string.replace(/\d/g,function(match){return symbolMap$8[match]})},week:{dow:1,doy:4}});
//! moment.js locale configuration
symbolMap$9={"1":"೧","2":"೨","3":"೩","4":"೪","5":"೫","6":"೬","7":"೭","8":"೮","9":"೯","0":"೦"};numberMap$8={"೧":"1","೨":"2","೩":"3","೪":"4","೫":"5","೬":"6","೭":"7","೮":"8","೯":"9","೦":"0"};hooks.defineLocale("kn",{months:"ಜನವರಿ_ಫೆಬ್ರವರಿ_ಮಾರ್ಚ್_ಏಪ್ರಿಲ್_ಮೇ_ಜೂನ್_ಜುಲೈ_ಆಗಸ್ಟ್_ಸೆಪ್ಟೆಂಬರ್_ಅಕ್ಟೋಬರ್_ನವೆಂಬರ್_ಡಿಸೆಂಬರ್".split("_"),monthsShort:"ಜನ_ಫೆಬ್ರ_ಮಾರ್ಚ್_ಏಪ್ರಿಲ್_ಮೇ_ಜೂನ್_ಜುಲೈ_ಆಗಸ್ಟ್_ಸೆಪ್ಟೆಂ_ಅಕ್ಟೋ_ನವೆಂ_ಡಿಸೆಂ".split("_"),monthsParseExact:!0,weekdays:"ಭಾನುವಾರ_ಸೋಮವಾರ_ಮಂಗಳವಾರ_ಬುಧವಾರ_ಗುರುವಾರ_ಶುಕ್ರವಾರ_ಶನಿವಾರ".split("_"),weekdaysShort:"ಭಾನು_ಸೋಮ_ಮಂಗಳ_ಬುಧ_ಗುರು_ಶುಕ್ರ_ಶನಿ".split("_"),weekdaysMin:"ಭಾ_ಸೋ_ಮಂ_ಬು_ಗು_ಶು_ಶ".split("_"),longDateFormat:{LT:"A h:mm",LTS:"A h:mm:ss",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY, A h:mm",LLLL:"dddd, D MMMM YYYY, A h:mm"},calendar:{sameDay:"[ಇಂದು] LT",nextDay:"[ನಾಳೆ] LT",nextWeek:"dddd, LT",lastDay:"[ನಿನ್ನೆ] LT",lastWeek:"[ಕೊನೆಯ] dddd, LT",sameElse:"L"},relativeTime:{future:"%s ನಂತರ",past:"%s ಹಿಂದೆ",s:"ಕೆಲವು ಕ್ಷಣಗಳು",ss:"%d ಸೆಕೆಂಡುಗಳು",m:"ಒಂದು ನಿಮಿಷ",mm:"%d ನಿಮಿಷ",h:"ಒಂದು ಗಂಟೆ",hh:"%d ಗಂಟೆ",d:"ಒಂದು ದಿನ",dd:"%d ದಿನ",M:"ಒಂದು ತಿಂಗಳು",MM:"%d ತಿಂಗಳು",y:"ಒಂದು ವರ್ಷ",yy:"%d ವರ್ಷ"},preparse:function(string){return string.replace(/[೧೨೩೪೫೬೭೮೯೦]/g,function(match){return numberMap$8[match]})},postformat:function(string){return string.replace(/\d/g,function(match){return symbolMap$9[match]})},meridiemParse:/ರಾತ್ರಿ|ಬೆಳಿಗ್ಗೆ|ಮಧ್ಯಾಹ್ನ|ಸಂಜೆ/,meridiemHour:function(hour,meridiem){return(hour===12&&(hour=0),meridiem==="ರಾತ್ರಿ")?hour<4?hour:hour+12:meridiem==="ಬೆಳಿಗ್ಗೆ"?hour:meridiem==="ಮಧ್ಯಾಹ್ನ"?hour>=10?hour:hour+12:meridiem==="ಸಂಜೆ"?hour+12:void 0},meridiem:function(hour){return hour<4?"ರಾತ್ರಿ":hour<10?"ಬೆಳಿಗ್ಗೆ":hour<17?"ಮಧ್ಯಾಹ್ನ":hour<20?"ಸಂಜೆ":"ರಾತ್ರಿ"},dayOfMonthOrdinalParse:/\d{1,2}(ನೇ)/,ordinal:function(number){return number+"ನೇ"},week:{dow:0,doy:6}});
//! moment.js locale configuration
hooks.defineLocale("ko",{months:"1월_2월_3월_4월_5월_6월_7월_8월_9월_10월_11월_12월".split("_"),monthsShort:"1월_2월_3월_4월_5월_6월_7월_8월_9월_10월_11월_12월".split("_"),weekdays:"일요일_월요일_화요일_수요일_목요일_금요일_토요일".split("_"),weekdaysShort:"일_월_화_수_목_금_토".split("_"),weekdaysMin:"일_월_화_수_목_금_토".split("_"),longDateFormat:{LT:"A h:mm",LTS:"A h:mm:ss",L:"YYYY.MM.DD.",LL:"YYYY년 MMMM D일",LLL:"YYYY년 MMMM D일 A h:mm",LLLL:"YYYY년 MMMM D일 dddd A h:mm",l:"YYYY.MM.DD.",ll:"YYYY년 MMMM D일",lll:"YYYY년 MMMM D일 A h:mm",llll:"YYYY년 MMMM D일 dddd A h:mm"},calendar:{sameDay:"오늘 LT",nextDay:"내일 LT",nextWeek:"dddd LT",lastDay:"어제 LT",lastWeek:"지난주 dddd LT",sameElse:"L"},relativeTime:{future:"%s 후",past:"%s 전",s:"몇 초",ss:"%d초",m:"1분",mm:"%d분",h:"한 시간",hh:"%d시간",d:"하루",dd:"%d일",M:"한 달",MM:"%d달",y:"일 년",yy:"%d년"},dayOfMonthOrdinalParse:/\d{1,2}(일|월|주)/,ordinal:function(number,period){switch(period){case"d":case"D":case"DDD":return number+"일";case"M":return number+"월";case"w":case"W":return number+"주";default:return number}},meridiemParse:/오전|오후/,isPM:function(token){return token==="오후"},meridiem:function(hour){return hour<12?"오전":"오후"}});
//! moment.js locale configuration
suffixes$2={0:"-чү",1:"-чи",2:"-чи",3:"-чү",4:"-чү",5:"-чи",6:"-чы",7:"-чи",8:"-чи",9:"-чу",10:"-чу",20:"-чы",30:"-чу",40:"-чы",50:"-чү",60:"-чы",70:"-чи",80:"-чи",90:"-чу",100:"-чү"};hooks.defineLocale("ky",{months:"январь_февраль_март_апрель_май_июнь_июль_август_сентябрь_октябрь_ноябрь_декабрь".split("_"),monthsShort:"янв_фев_март_апр_май_июнь_июль_авг_сен_окт_ноя_дек".split("_"),weekdays:"Жекшемби_Дүйшөмбү_Шейшемби_Шаршемби_Бейшемби_Жума_Ишемби".split("_"),weekdaysShort:"Жек_Дүй_Шей_Шар_Бей_Жум_Ише".split("_"),weekdaysMin:"Жк_Дй_Шй_Шр_Бй_Жм_Иш".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd, D MMMM YYYY HH:mm"},calendar:{sameDay:"[Бүгүн саат] LT",nextDay:"[Эртең саат] LT",nextWeek:"dddd [саат] LT",lastDay:"[Кече саат] LT",lastWeek:"[Өткен аптанын] dddd [күнү] [саат] LT",sameElse:"L"},relativeTime:{future:"%s ичинде",past:"%s мурун",s:"бирнече секунд",ss:"%d секунд",m:"бир мүнөт",mm:"%d мүнөт",h:"бир саат",hh:"%d саат",d:"бир күн",dd:"%d күн",M:"бир ай",MM:"%d ай",y:"бир жыл",yy:"%d жыл"},dayOfMonthOrdinalParse:/\d{1,2}-(чи|чы|чү|чу)/,ordinal:function(number){var a=number%10,b=number>=100?100:null;return number+(suffixes$2[number]||suffixes$2[a]||suffixes$2[b])},week:{dow:1,doy:7}});
//! moment.js locale configuration
...
//! moment.js locale configuration
hooks.defineLocale("ml",{months:"ജനുവരി_ഫെബ്രുവരി_മാർച്ച്_ഏപ്രിൽ_മേയ്_ജൂൺ_ജൂലൈ_ഓഗസ്റ്റ്_സെപ്റ്റംബർ_ഒക്ടോബർ_നവംബർ_ഡിസംബർ".split("_"),monthsShort:"ജനു._ഫെബ്രു._മാർ._ഏപ്രി._മേയ്_ജൂൺ_ജൂലൈ._ഓഗ._സെപ്റ്റ._ഒക്ടോ._നവം._ഡിസം.".split("_"),monthsParseExact:!0,weekdays:"ഞായറാഴ്ച_തിങ്കളാഴ്ച_ചൊവ്വാഴ്ച_ബുധനാഴ്ച_വ്യാഴാഴ്ച_വെള്ളിയാഴ്ച_ശനിയാഴ്ച".split("_"),weekdaysShort:"ഞായർ_തിങ്കൾ_ചൊവ്വ_ബുധൻ_വ്യാഴം_വെള്ളി_ശനി".split("_"),weekdaysMin:"ഞാ_തി_ചൊ_ബു_വ്യാ_വെ_ശ".split("_"),longDateFormat:{LT:"A h:mm -നു",LTS:"A h:mm:ss -നു",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY, A h:mm -നു",LLLL:"dddd, D MMMM YYYY, A h:mm -നു"},calendar:{sameDay:"[ഇന്ന്] LT",nextDay:"[നാളെ] LT",nextWeek:"dddd, LT",lastDay:"[ഇന്നലെ] LT",lastWeek:"[കഴിഞ്ഞ] dddd, LT",sameElse:"L"},relativeTime:{future:"%s കഴിഞ്ഞ്",past:"%s മുൻപ്",s:"അൽപ നിമിഷങ്ങൾ",ss:"%d സെക്കൻഡ്",m:"ഒരു മിനിറ്റ്",mm:"%d മിനിറ്റ്",h:"ഒരു മണിക്കൂർ",hh:"%d മണിക്കൂർ",d:"ഒരു ദിവസം",dd:"%d ദിവസം",M:"ഒരു മാസം",MM:"%d മാസം",y:"ഒരു വർഷം",yy:"%d വർഷം"},meridiemParse:/രാത്രി|രാവിലെ|ഉച്ച കഴിഞ്ഞ്|വൈകുന്നേരം|രാത്രി/i,meridiemHour:function(hour,meridiem){return hour===12&&(hour=0),meridiem==="രാത്രി"&&hour>=4||meridiem==="ഉച്ച കഴിഞ്ഞ്"||meridiem==="വൈകുന്നേരം"?hour+12:hour},meridiem:function(hour){return hour<4?"രാത്രി":hour<12?"രാവിലെ":hour<17?"ഉച്ച കഴിഞ്ഞ്":hour<20?"വൈകുന്നേരം":"രാത്രി"}});
//! moment.js locale configuration
hooks.defineLocale("mn",{months:"Нэгдүгээр сар_Хоёрдугаар сар_Гуравдугаар сар_Дөрөвдүгээр сар_Тавдугаар сар_Зургадугаар сар_Долдугаар сар_Наймдугаар сар_Есдүгээр сар_Аравдугаар сар_Арван нэгдүгээр сар_Арван хоёрдугаар сар".split("_"),monthsShort:"1 сар_2 сар_3 сар_4 сар_5 сар_6 сар_7 сар_8 сар_9 сар_10 сар_11 сар_12 сар".split("_"),monthsParseExact:!0,weekdays:"Ням_Даваа_Мягмар_Лхагва_Пүрэв_Баасан_Бямба".split("_"),weekdaysShort:"Ням_Дав_Мяг_Лха_Пүр_Баа_Бям".split("_"),weekdaysMin:"Ня_Да_Мя_Лх_Пү_Ба_Бя".split("_"),weekdaysParseExact:!0,longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY-MM-DD",LL:"YYYY оны MMMMын D",LLL:"YYYY оны MMMMын D HH:mm",LLLL:"dddd, YYYY оны MMMMын D HH:mm"},meridiemParse:/ҮӨ|ҮХ/i,isPM:function(input){return input==="ҮХ"},meridiem:function(hour){return hour<12?"ҮӨ":"ҮХ"},calendar:{sameDay:"[Өнөөдөр] LT",nextDay:"[Маргааш] LT",nextWeek:"[Ирэх] dddd LT",lastDay:"[Өчигдөр] LT",lastWeek:"[Өнгөрсөн] dddd LT",sameElse:"L"},relativeTime:{future:"%s дараа",past:"%s өмнө",s:translate$7,ss:translate$7,m:translate$7,mm:translate$7,h:translate$7,hh:translate$7,d:translate$7,dd:translate$7,M:translate$7,MM:translate$7,y:translate$7,yy:translate$7},dayOfMonthOrdinalParse:/\d{1,2} өдөр/,ordinal:function(number,period){switch(period){case"d":case"D":case"DDD":return number+" өдөр";default:return number}}});
//! moment.js locale configuration
symbolMap$a={"1":"१","2":"२","3":"३","4":"४","5":"५","6":"६","7":"७","8":"८","9":"९","0":"०"};numberMap$9={"१":"1","२":"2","३":"3","४":"4","५":"5","६":"6","७":"7","८":"8","९":"9","०":"0"};hooks.defineLocale("mr",{months:"जानेवारी_फेब्रुवारी_मार्च_एप्रिल_मे_जून_जुलै_ऑगस्ट_सप्टेंबर_ऑक्टोबर_नोव्हेंबर_डिसेंबर".split("_"),monthsShort:"जाने._फेब्रु._मार्च._एप्रि._मे._जून._जुलै._ऑग._सप्टें._ऑक्टो._नोव्हें._डिसें.".split("_"),monthsParseExact:!0,weekdays:"रविवार_सोमवार_मंगळवार_बुधवार_गुरूवार_शुक्रवार_शनिवार".split("_"),weekdaysShort:"रवि_सोम_मंगळ_बुध_गुरू_शुक्र_शनि".split("_"),weekdaysMin:"र_सो_मं_बु_गु_शु_श".split("_"),longDateFormat:{LT:"A h:mm वाजता",LTS:"A h:mm:ss वाजता",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY, A h:mm वाजता",LLLL:"dddd, D MMMM YYYY, A h:mm वाजता"},calendar:{sameDay:"[आज] LT",nextDay:"[उद्या] LT",nextWeek:"dddd, LT",lastDay:"[काल] LT",lastWeek:"[मागील] dddd, LT",sameElse:"L"},relativeTime:{future:"%sमध्ये",past:"%sपूर्वी",s:relativeTimeMr,ss:relativeTimeMr,m:relativeTimeMr,mm:relativeTimeMr,h:relativeTimeMr,hh:relativeTimeMr,d:relativeTimeMr,dd:relativeTimeMr,M:relativeTimeMr,MM:relativeTimeMr,y:relativeTimeMr,yy:relativeTimeMr},preparse:function(string){return string.replace(/[१२३४५६७८९०]/g,function(match){return numberMap$9[match]})},postformat:function(string){return string.replace(/\d/g,function(match){return symbolMap$a[match]})},meridiemParse:/रात्री|सकाळी|दुपारी|सायंकाळी/,meridiemHour:function(hour,meridiem){return(hour===12&&(hour=0),meridiem==="रात्री")?hour<4?hour:hour+12:meridiem==="सकाळी"?hour:meridiem==="दुपारी"?hour>=10?hour:hour+12:meridiem==="सायंकाळी"?hour+12:void 0},meridiem:function(hour){return hour<4?"रात्री":hour<10?"सकाळी":hour<17?"दुपारी":hour<20?"सायंकाळी":"रात्री"},week:{dow:0,doy:6}});
//! moment.js locale configuration
hooks.defineLocale("ms-my",{months:"Januari_Februari_Mac_April_Mei_Jun_Julai_Ogos_September_Oktober_November_Disember".split("_"),monthsShort:"Jan_Feb_Mac_Apr_Mei_Jun_Jul_Ogs_Sep_Okt_Nov_Dis".split("_"),weekdays:"Ahad_Isnin_Selasa_Rabu_Khamis_Jumaat_Sabtu".split("_"),weekdaysShort:"Ahd_Isn_Sel_Rab_Kha_Jum_Sab".split("_"),weekdaysMin:"Ah_Is_Sl_Rb_Km_Jm_Sb".split("_"),longDateFormat:{LT:"HH.mm",LTS:"HH.mm.ss",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY [pukul] HH.mm",LLLL:"dddd, D MMMM YYYY [pukul] HH.mm"},meridiemParse:/pagi|tengahari|petang|malam/,meridiemHour:function(hour,meridiem){return(hour===12&&(hour=0),meridiem==="pagi")?hour:meridiem==="tengahari"?hour>=11?hour:hour+12:meridiem==="petang"||meridiem==="malam"?hour+12:void 0},meridiem:function(hours){return hours<11?"pagi":hours<15?"tengahari":hours<19?"petang":"malam"},calendar:{sameDay:"[Hari ini pukul] LT",nextDay:"[Esok pukul] LT",nextWeek:"dddd [pukul] LT",lastDay:"[Kelmarin pukul] LT",lastWeek:"dddd [lepas pukul] LT",sameElse:"L"},relativeTime:{future:"dalam %s",past:"%s yang lepas",s:"beberapa saat",ss:"%d saat",m:"seminit",mm:"%d minit",h:"sejam",hh:"%d jam",d:"sehari",dd:"%d hari",M:"sebulan",MM:"%d bulan",y:"setahun",yy:"%d tahun"},week:{dow:1,doy:7}});
//! moment.js locale configuration
...
//! moment.js locale configuration
symbolMap$d={"1":"੧","2":"੨","3":"੩","4":"੪","5":"੫","6":"੬","7":"੭","8":"੮","9":"੯","0":"੦"};numberMap$c={"੧":"1","੨":"2","੩":"3","੪":"4","੫":"5","੬":"6","੭":"7","੮":"8","੯":"9","੦":"0"};hooks.defineLocale("pa-in",{months:"ਜਨਵਰੀ_ਫ਼ਰਵਰੀ_ਮਾਰਚ_ਅਪ੍ਰੈਲ_ਮਈ_ਜੂਨ_ਜੁਲਾਈ_ਅਗਸਤ_ਸਤੰਬਰ_ਅਕਤੂਬਰ_ਨਵੰਬਰ_ਦਸੰਬਰ".split("_"),monthsShort:"ਜਨਵਰੀ_ਫ਼ਰਵਰੀ_ਮਾਰਚ_ਅਪ੍ਰੈਲ_ਮਈ_ਜੂਨ_ਜੁਲਾਈ_ਅਗਸਤ_ਸਤੰਬਰ_ਅਕਤੂਬਰ_ਨਵੰਬਰ_ਦਸੰਬਰ".split("_"),weekdays:"ਐਤਵਾਰ_ਸੋਮਵਾਰ_ਮੰਗਲਵਾਰ_ਬੁਧਵਾਰ_ਵੀਰਵਾਰ_ਸ਼ੁੱਕਰਵਾਰ_ਸ਼ਨੀਚਰਵਾਰ".split("_"),weekdaysShort:"ਐਤ_ਸੋਮ_ਮੰਗਲ_ਬੁਧ_ਵੀਰ_ਸ਼ੁਕਰ_ਸ਼ਨੀ".split("_"),weekdaysMin:"ਐਤ_ਸੋਮ_ਮੰਗਲ_ਬੁਧ_ਵੀਰ_ਸ਼ੁਕਰ_ਸ਼ਨੀ".split("_"),longDateFormat:{LT:"A h:mm ਵਜੇ",LTS:"A h:mm:ss ਵਜੇ",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY, A h:mm ਵਜੇ",LLLL:"dddd, D MMMM YYYY, A h:mm ਵਜੇ"},calendar:{sameDay:"[ਅਜ] LT",nextDay:"[ਕਲ] LT",nextWeek:"[ਅਗਲਾ] dddd, LT",lastDay:"[ਕਲ] LT",lastWeek:"[ਪਿਛਲੇ] dddd, LT",sameElse:"L"},relativeTime:{future:"%s ਵਿੱਚ",past:"%s ਪਿਛਲੇ",s:"ਕੁਝ ਸਕਿੰਟ",ss:"%d ਸਕਿੰਟ",m:"ਇਕ ਮਿੰਟ",mm:"%d ਮਿੰਟ",h:"ਇੱਕ ਘੰਟਾ",hh:"%d ਘੰਟੇ",d:"ਇੱਕ ਦਿਨ",dd:"%d ਦਿਨ",M:"ਇੱਕ ਮਹੀਨਾ",MM:"%d ਮਹੀਨੇ",y:"ਇੱਕ ਸਾਲ",yy:"%d ਸਾਲ"},preparse:function(string){return string.replace(/[੧੨੩੪੫੬੭੮੯੦]/g,function(match){return numberMap$c[match]})},postformat:function(string){return string.replace(/\d/g,function(match){return symbolMap$d[match]})},meridiemParse:/ਰਾਤ|ਸਵੇਰ|ਦੁਪਹਿਰ|ਸ਼ਾਮ/,meridiemHour:function(hour,meridiem){return(hour===12&&(hour=0),meridiem==="ਰਾਤ")?hour<4?hour:hour+12:meridiem==="ਸਵੇਰ"?hour:meridiem==="ਦੁਪਹਿਰ"?hour>=10?hour:hour+12:meridiem==="ਸ਼ਾਮ"?hour+12:void 0},meridiem:function(hour){return hour<4?"ਰਾਤ":hour<10?"ਸਵੇਰ":hour<17?"ਦੁਪਹਿਰ":hour<20?"ਸ਼ਾਮ":"ਰਾਤ"},week:{dow:0,doy:6}});
//! moment.js locale configuration
...
//! moment.js locale configuration
numbersNouns="pagh_wa’_cha’_wej_loS_vagh_jav_Soch_chorgh_Hut".split("_");hooks.defineLocale("tlh",{months:"tera’ jar wa’_tera’ jar cha’_tera’ jar wej_tera’ jar loS_tera’ jar vagh_tera’ jar jav_tera’ jar Soch_tera’ jar chorgh_tera’ jar Hut_tera’ jar wa’maH_tera’ jar wa’maH wa’_tera’ jar wa’maH cha’".split("_"),monthsShort:"jar wa’_jar cha’_jar wej_jar loS_jar vagh_jar jav_jar Soch_jar chorgh_jar Hut_jar wa’maH_jar wa’maH wa’_jar wa’maH cha’".split("_"),monthsParseExact:!0,weekdays:"lojmItjaj_DaSjaj_povjaj_ghItlhjaj_loghjaj_buqjaj_ghInjaj".split("_"),weekdaysShort:"lojmItjaj_DaSjaj_povjaj_ghItlhjaj_loghjaj_buqjaj_ghInjaj".split("_"),weekdaysMin:"lojmItjaj_DaSjaj_povjaj_ghItlhjaj_loghjaj_buqjaj_ghInjaj".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd, D MMMM YYYY HH:mm"},calendar:{sameDay:"[DaHjaj] LT",nextDay:"[wa’leS] LT",nextWeek:"LLL",lastDay:"[wa’Hu’] LT",lastWeek:"LLL",sameElse:"L"},relativeTime:{future:translateFuture,past:translatePast,s:"puS lup",ss:translate$a,m:"wa’ tup",mm:translate$a,h:"wa’ rep",hh:translate$a,d:"wa’ jaj",dd:translate$a,M:"wa’ jar",MM:translate$a,y:"wa’ DIS",yy:translate$a},dayOfMonthOrdinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});suffixes$4={1:"'inci",5:"'inci",8:"'inci",70:"'inci",80:"'inci",2:"'nci",7:"'nci",20:"'nci",50:"'nci",3:"'üncü",4:"'üncü",100:"'üncü",6:"'ncı",9:"'uncu",10:"'uncu",30:"'uncu",60:"'ıncı",90:"'ıncı"};hooks.defineLocale("tr",{months:"Ocak_Şubat_Mart_Nisan_Mayıs_Haziran_Temmuz_Ağustos_Eylül_Ekim_Kasım_Aralık".split("_"),monthsShort:"Oca_Şub_Mar_Nis_May_Haz_Tem_Ağu_Eyl_Eki_Kas_Ara".split("_"),weekdays:"Pazar_Pazartesi_Salı_Çarşamba_Perşembe_Cuma_Cumartesi".split("_"),weekdaysShort:"Paz_Pts_Sal_Çar_Per_Cum_Cts".split("_"),weekdaysMin:"Pz_Pt_Sa_Ça_Pe_Cu_Ct".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd, D MMMM YYYY HH:mm"},calendar:{sameDay:"[bugün saat] LT",nextDay:"[yarın saat] LT",nextWeek:"[gelecek] dddd [saat] LT",lastDay:"[dün] LT",lastWeek:"[geçen] dddd [saat] LT",sameElse:"L"},relativeTime:{future:"%s sonra",past:"%s önce",s:"birkaç saniye",ss:"%d saniye",m:"bir dakika",mm:"%d dakika",h:"bir saat",hh:"%d saat",d:"bir gün",dd:"%d gün",M:"bir ay",MM:"%d ay",y:"bir yıl",yy:"%d yıl"},ordinal:function(number,period){switch(period){case"d":case"D":case"Do":case"DD":return number;default:if(number===0)return number+"'ıncı";var a=number%10,b=number%100-a,c=number>=100?100:null;return number+(suffixes$4[a]||suffixes$4[b]||suffixes$4[c])}},week:{dow:1,doy:7}});
//! moment.js locale configuration
...
//! moment.js locale configuration
hooks.defineLocale("zh-cn",{months:"一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"),monthsShort:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),weekdays:"星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"),weekdaysShort:"周日_周一_周二_周三_周四_周五_周六".split("_"),weekdaysMin:"日_一_二_三_四_五_六".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY/MM/DD",LL:"YYYY年M月D日",LLL:"YYYY年M月D日Ah点mm分",LLLL:"YYYY年M月D日ddddAh点mm分",l:"YYYY/M/D",ll:"YYYY年M月D日",lll:"YYYY年M月D日 HH:mm",llll:"YYYY年M月D日dddd HH:mm"},meridiemParse:/凌晨|早上|上午|中午|下午|晚上/,meridiemHour:function(hour,meridiem){return hour===12&&(hour=0),meridiem==="凌晨"||meridiem==="早上"||meridiem==="上午"?hour:meridiem==="下午"||meridiem==="晚上"?hour+12:hour>=11?hour:hour+12},meridiem:function(hour,minute){var hm=hour*100+minute;return hm<600?"凌晨":hm<900?"早上":hm<1130?"上午":hm<1230?"中午":hm<1800?"下午":"晚上"},calendar:{sameDay:"[今天]LT",nextDay:"[明天]LT",nextWeek:"[下]ddddLT",lastDay:"[昨天]LT",lastWeek:"[上]ddddLT",sameElse:"L"},dayOfMonthOrdinalParse:/\d{1,2}(日|月|周)/,ordinal:function(number,period){switch(period){case"d":case"D":case"DDD":return number+"日";case"M":return number+"月";case"w":case"W":return number+"周";default:return number}},relativeTime:{future:"%s内",past:"%s前",s:"几秒",ss:"%d 秒",m:"1 分钟",mm:"%d 分钟",h:"1 小时",hh:"%d 小时",d:"1 天",dd:"%d 天",M:"1 个月",MM:"%d 个月",y:"1 年",yy:"%d 年"},week:{dow:1,doy:4}});
//! moment.js locale configuration
hooks.defineLocale("zh-hk",{months:"一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"),monthsShort:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),weekdays:"星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"),weekdaysShort:"週日_週一_週二_週三_週四_週五_週六".split("_"),weekdaysMin:"日_一_二_三_四_五_六".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY/MM/DD",LL:"YYYY年M月D日",LLL:"YYYY年M月D日 HH:mm",LLLL:"YYYY年M月D日dddd HH:mm",l:"YYYY/M/D",ll:"YYYY年M月D日",lll:"YYYY年M月D日 HH:mm",llll:"YYYY年M月D日dddd HH:mm"},meridiemParse:/凌晨|早上|上午|中午|下午|晚上/,meridiemHour:function(hour,meridiem){return(hour===12&&(hour=0),meridiem==="凌晨"||meridiem==="早上"||meridiem==="上午")?hour:meridiem==="中午"?hour>=11?hour:hour+12:meridiem==="下午"||meridiem==="晚上"?hour+12:void 0},meridiem:function(hour,minute){var hm=hour*100+minute;return hm<600?"凌晨":hm<900?"早上":hm<1130?"上午":hm<1230?"中午":hm<1800?"下午":"晚上"},calendar:{sameDay:"[今天]LT",nextDay:"[明天]LT",nextWeek:"[下]ddddLT",lastDay:"[昨天]LT",lastWeek:"[上]ddddLT",sameElse:"L"},dayOfMonthOrdinalParse:/\d{1,2}(日|月|週)/,ordinal:function(number,period){switch(period){case"d":case"D":case"DDD":return number+"日";case"M":return number+"月";case"w":case"W":return number+"週";default:return number}},relativeTime:{future:"%s內",past:"%s前",s:"幾秒",ss:"%d 秒",m:"1 分鐘",mm:"%d 分鐘",h:"1 小時",hh:"%d 小時",d:"1 天",dd:"%d 天",M:"1 個月",MM:"%d 個月",y:"1 年",yy:"%d 年"}});
//! moment.js locale configuration
return hooks.defineLocale("zh-tw",{months:"一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"),monthsShort:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),weekdays:"星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"),weekdaysShort:"週日_週一_週二_週三_週四_週五_週六".split("_"),weekdaysMin:"日_一_二_三_四_五_六".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY/MM/DD",LL:"YYYY年M月D日",LLL:"YYYY年M月D日 HH:mm",LLLL:"YYYY年M月D日dddd HH:mm",l:"YYYY/M/D",ll:"YYYY年M月D日",lll:"YYYY年M月D日 HH:mm",llll:"YYYY年M月D日dddd HH:mm"},meridiemParse:/凌晨|早上|上午|中午|下午|晚上/,meridiemHour:function(hour,meridiem){return(hour===12&&(hour=0),meridiem==="凌晨"||meridiem==="早上"||meridiem==="上午")?hour:meridiem==="中午"?hour>=11?hour:hour+12:meridiem==="下午"||meridiem==="晚上"?hour+12:void 0},meridiem:function(hour,minute){var hm=hour*100+minute;return hm<600?"凌晨":hm<900?"早上":hm<1130?"上午":hm<1230?"中午":hm<1800?"下午":"晚上"},calendar:{sameDay:"[今天] LT",nextDay:"[明天] LT",nextWeek:"[下]dddd LT",lastDay:"[昨天] LT",lastWeek:"[上]dddd LT",sameElse:"L"},dayOfMonthOrdinalParse:/\d{1,2}(日|月|週)/,ordinal:function(number,period){switch(period){case"d":case"D":case"DDD":return number+"日";case"M":return number+"月";case"w":case"W":return number+"週";default:return number}},relativeTime:{future:"%s內",past:"%s前",s:"幾秒",ss:"%d 秒",m:"1 分鐘",mm:"%d 分鐘",h:"1 小時",hh:"%d 小時",d:"1 天",dd:"%d 天",M:"1 個月",MM:"%d 個月",y:"1 年",yy:"%d 年"}}),hooks.locale("en"),hooks});
/*@preserve
 * Tempus Dominus Bootstrap4 v5.1.2 (https://tempusdominus.github.io/bootstrap-4/)
 * Copyright 2016-2018 Jonathan Peterson
 * Licensed under MIT (https://github.com/tempusdominus/bootstrap-3/blob/master/LICENSE)
 */
if(typeof jQuery=="undefined")throw new Error("Tempus Dominus Bootstrap4's requires jQuery. jQuery must be included before Tempus Dominus Bootstrap4's JavaScript.");if(+function($){var version=$.fn.jquery.split(" ")[0].split(".");if(version[0]<2&&version[1]<9||version[0]===1&&version[1]===9&&version[2]<1||version[0]>=4)throw new Error("Tempus Dominus Bootstrap4's requires at least jQuery v3.0.0 but less than v4.0.0");}(jQuery),typeof moment=="undefined")throw new Error("Tempus Dominus Bootstrap4's requires moment.js. Moment.js must be included before Tempus Dominus Bootstrap4's JavaScript.");if(version=moment.version.split("."),version[0]<=2&&version[1]<17||version[0]>=3)throw new Error("Tempus Dominus Bootstrap4's requires at least moment.js v2.17.0 but less than v3.0.0");+function(){function _possibleConstructorReturn(self,call){if(!self)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return call&&(typeof call=="object"||typeof call=="function")?call:self}function _inherits(subClass,superClass){if(typeof superClass!="function"&&superClass!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:!1,writable:!0,configurable:!0}});superClass&&(Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass)}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function");}var _typeof=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(obj){return typeof obj}:function(obj){return obj&&typeof Symbol=="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj},_createClass=function(){function defineProperties(target,props){for(var descriptor,i=0;i<props.length;i++)descriptor=props[i],descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),DateTimePicker=function($,moment){var NAME="datetimepicker",DATA_KEY=""+NAME,EVENT_KEY="."+DATA_KEY,DATA_API_KEY=".data-api",Selector={DATA_TOGGLE:'[data-toggle="'+DATA_KEY+'"]'},ClassName={INPUT:NAME+"-input"},Event={CHANGE:"change"+EVENT_KEY,BLUR:"blur"+EVENT_KEY,KEYUP:"keyup"+EVENT_KEY,KEYDOWN:"keydown"+EVENT_KEY,FOCUS:"focus"+EVENT_KEY,CLICK_DATA_API:"click"+EVENT_KEY+DATA_API_KEY,UPDATE:"update"+EVENT_KEY,ERROR:"error"+EVENT_KEY,HIDE:"hide"+EVENT_KEY,SHOW:"show"+EVENT_KEY},DatePickerModes=[{CLASS_NAME:"days",NAV_FUNCTION:"M",NAV_STEP:1},{CLASS_NAME:"months",NAV_FUNCTION:"y",NAV_STEP:1},{CLASS_NAME:"years",NAV_FUNCTION:"y",NAV_STEP:10},{CLASS_NAME:"decades",NAV_FUNCTION:"y",NAV_STEP:100}],KeyMap={up:38,38:"up",down:40,40:"down",left:37,37:"left",right:39,39:"right",tab:9,9:"tab",escape:27,27:"escape",enter:13,13:"enter",pageUp:33,33:"pageUp",pageDown:34,34:"pageDown",shift:16,16:"shift",control:17,17:"control",space:32,32:"space",t:84,84:"t","delete":46,46:"delete"},ViewModes=["times","days","months","years","decades"],keyState={},keyPressHandled={},Default={timeZone:"",format:!1,dayViewHeaderFormat:"MMMM YYYY",extraFormats:!1,stepping:1,minDate:!1,maxDate:!1,useCurrent:!0,collapse:!0,locale:moment.locale(),defaultDate:!1,disabledDates:!1,enabledDates:!1,icons:{time:"fa fa-clock-o",date:"fa fa-calendar",up:"fa fa-arrow-up",down:"fa fa-arrow-down",previous:"fa fa-chevron-left",next:"fa fa-chevron-right",today:"fa fa-calendar-check-o",clear:"fa fa-delete",close:"fa fa-times"},tooltips:{today:"Go to today",clear:"Clear selection",close:"Close the picker",selectMonth:"Select Month",prevMonth:"Previous Month",nextMonth:"Next Month",selectYear:"Select Year",prevYear:"Previous Year",nextYear:"Next Year",selectDecade:"Select Decade",prevDecade:"Previous Decade",nextDecade:"Next Decade",prevCentury:"Previous Century",nextCentury:"Next Century",pickHour:"Pick Hour",incrementHour:"Increment Hour",decrementHour:"Decrement Hour",pickMinute:"Pick Minute",incrementMinute:"Increment Minute",decrementMinute:"Decrement Minute",pickSecond:"Pick Second",incrementSecond:"Increment Second",decrementSecond:"Decrement Second",togglePeriod:"Toggle Period",selectTime:"Select Time",selectDate:"Select Date"},useStrict:!1,sideBySide:!1,daysOfWeekDisabled:!1,calendarWeeks:!1,viewMode:"days",toolbarPlacement:"default",buttons:{showToday:!1,showClear:!1,showClose:!1},widgetPositioning:{horizontal:"auto",vertical:"auto"},widgetParent:null,ignoreReadonly:!1,keepOpen:!1,focusOnShow:!0,inline:!1,keepInvalid:!1,keyBinds:{up:function(){if(!this.widget)return!1;var d=this._dates[0]||this.getMoment();return this.widget.find(".datepicker").is(":visible")?this.date(d.clone().subtract(7,"d")):this.date(d.clone().add(this.stepping(),"m")),!0},down:function(){if(!this.widget)return this.show(),!1;var d=this._dates[0]||this.getMoment();return this.widget.find(".datepicker").is(":visible")?this.date(d.clone().add(7,"d")):this.date(d.clone().subtract(this.stepping(),"m")),!0},"control up":function(){if(!this.widget)return!1;var d=this._dates[0]||this.getMoment();return this.widget.find(".datepicker").is(":visible")?this.date(d.clone().subtract(1,"y")):this.date(d.clone().add(1,"h")),!0},"control down":function(){if(!this.widget)return!1;var d=this._dates[0]||this.getMoment();return this.widget.find(".datepicker").is(":visible")?this.date(d.clone().add(1,"y")):this.date(d.clone().subtract(1,"h")),!0},left:function(){if(!this.widget)return!1;var d=this._dates[0]||this.getMoment();return this.widget.find(".datepicker").is(":visible")&&this.date(d.clone().subtract(1,"d")),!0},right:function(){if(!this.widget)return!1;var d=this._dates[0]||this.getMoment();return this.widget.find(".datepicker").is(":visible")&&this.date(d.clone().add(1,"d")),!0},pageUp:function(){if(!this.widget)return!1;var d=this._dates[0]||this.getMoment();return this.widget.find(".datepicker").is(":visible")&&this.date(d.clone().subtract(1,"M")),!0},pageDown:function(){if(!this.widget)return!1;var d=this._dates[0]||this.getMoment();return this.widget.find(".datepicker").is(":visible")&&this.date(d.clone().add(1,"M")),!0},enter:function(){return this.widget?(this.hide(),!0):!1},escape:function(){return this.widget?(this.hide(),!0):!1},"control space":function(){return this.widget?(this.widget.find(".timepicker").is(":visible")&&this.widget.find('.btn[data-action="togglePeriod"]').click(),!0):!1},t:function(){return this.widget?(this.date(this.getMoment()),!0):!1},"delete":function(){return this.widget?(this.clear(),!0):!1}},debug:!1,allowInputToggle:!1,disabledTimeIntervals:!1,disabledHours:!1,enabledHours:!1,viewDate:!1,allowMultidate:!1,multidateSeparator:","};return function(){function DateTimePicker(element,options){_classCallCheck(this,DateTimePicker);this._options=this._getOptions(options);this._element=element;this._dates=[];this._datesFormatted=[];this._viewDate=null;this.unset=!0;this.component=!1;this.widget=!1;this.use24Hours=null;this.actualFormat=null;this.parseFormats=null;this.currentViewMode=null;this.MinViewModeNumber=0;this._int()}return DateTimePicker.prototype._int=function(){var targetInput=this._element.data("target-input");this._element.is("input")?this.input=this._element:targetInput!==undefined&&(this.input=targetInput==="nearest"?this._element.find("input"):$(targetInput));this._dates=[];this._dates[0]=this.getMoment();this._viewDate=this.getMoment().clone();$.extend(!0,this._options,this._dataToOptions());this.options(this._options);this._initFormatting();this.input!==undefined&&this.input.is("input")&&this.input.val().trim().length!==0?this._setValue(this._parseInputDate(this.input.val().trim()),0):this._options.defaultDate&&this.input!==undefined&&this.input.attr("placeholder")===undefined&&this._setValue(this._options.defaultDate,0);this._options.inline&&this.show()},DateTimePicker.prototype._update=function(){this.widget&&(this._fillDate(),this._fillTime())},DateTimePicker.prototype._setValue=function(targetMoment,index){var oldDate=this.unset?null:this._dates[index],outpValue="",i;if(!targetMoment){this._options.allowMultidate&&this._dates.length!==1?(outpValue=this._element.data("date")+",",outpValue=outpValue.replace(oldDate.format(this.actualFormat)+",","").replace(",,","").replace(/,\s*$/,""),this._dates.splice(index,1),this._datesFormatted.splice(index,1)):(this.unset=!0,this._dates=[],this._datesFormatted=[]);this.input!==undefined&&(this.input.val(outpValue),this.input.trigger("input"));this._element.data("date",outpValue);this._notifyEvent({type:DateTimePicker.Event.CHANGE,date:!1,oldDate:oldDate});this._update();return}if(targetMoment=targetMoment.clone().locale(this._options.locale),this._hasTimeZone()&&targetMoment.tz(this._options.timeZone),this._options.stepping!==1&&targetMoment.minutes(Math.round(targetMoment.minutes()/this._options.stepping)*this._options.stepping).seconds(0),this._isValid(targetMoment)){if(this._dates[index]=targetMoment,this._datesFormatted[index]=targetMoment.format("YYYY-MM-DD"),this._viewDate=targetMoment.clone(),this._options.allowMultidate&&this._dates.length>1){for(i=0;i<this._dates.length;i++)outpValue+=""+this._dates[i].format(this.actualFormat)+this._options.multidateSeparator;outpValue=outpValue.replace(/,\s*$/,"")}else outpValue=this._dates[index].format(this.actualFormat);this.input!==undefined&&(this.input.val(outpValue),this.input.trigger("input"));this._element.data("date",outpValue);this.unset=!1;this._update();this._notifyEvent({type:DateTimePicker.Event.CHANGE,date:this._dates[index].clone(),oldDate:oldDate})}else this._options.keepInvalid?this._notifyEvent({type:DateTimePicker.Event.CHANGE,date:targetMoment,oldDate:oldDate}):this.input!==undefined&&(this.input.val(""+(this.unset?"":this._dates[index].format(this.actualFormat))),this.input.trigger("input")),this._notifyEvent({type:DateTimePicker.Event.ERROR,date:targetMoment,oldDate:oldDate})},DateTimePicker.prototype._change=function(e){var val=$(e.target).val().trim(),parsedDate=val?this._parseInputDate(val):null;return this._setValue(parsedDate),e.stopImmediatePropagation(),!1},DateTimePicker.prototype._getOptions=function(options){return $.extend(!0,{},Default,options)},DateTimePicker.prototype._hasTimeZone=function(){return moment.tz!==undefined&&this._options.timeZone!==undefined&&this._options.timeZone!==null&&this._options.timeZone!==""},DateTimePicker.prototype._isEnabled=function(granularity){if(typeof granularity!="string"||granularity.length>1)throw new TypeError("isEnabled expects a single character string parameter");switch(granularity){case"y":return this.actualFormat.indexOf("Y")!==-1;case"M":return this.actualFormat.indexOf("M")!==-1;case"d":return this.actualFormat.toLowerCase().indexOf("d")!==-1;case"h":case"H":return this.actualFormat.toLowerCase().indexOf("h")!==-1;case"m":return this.actualFormat.indexOf("m")!==-1;case"s":return this.actualFormat.indexOf("s")!==-1;case"a":case"A":return this.actualFormat.toLowerCase().indexOf("a")!==-1;default:return!1}},DateTimePicker.prototype._hasTime=function(){return this._isEnabled("h")||this._isEnabled("m")||this._isEnabled("s")},DateTimePicker.prototype._hasDate=function(){return this._isEnabled("y")||this._isEnabled("M")||this._isEnabled("d")},DateTimePicker.prototype._dataToOptions=function(){var eData=this._element.data(),dataOptions={};return eData.dateOptions&&eData.dateOptions instanceof Object&&(dataOptions=$.extend(!0,dataOptions,eData.dateOptions)),$.each(this._options,function(key){var attributeName="date"+key.charAt(0).toUpperCase()+key.slice(1);eData[attributeName]!==undefined?dataOptions[key]=eData[attributeName]:delete dataOptions[key]}),dataOptions},DateTimePicker.prototype._notifyEvent=function(e){(e.type!==DateTimePicker.Event.CHANGE||!e.date||!e.date.isSame(e.oldDate))&&(e.date||e.oldDate)&&this._element.trigger(e)},DateTimePicker.prototype._viewUpdate=function(e){e==="y"&&(e="YYYY");this._notifyEvent({type:DateTimePicker.Event.UPDATE,change:e,viewDate:this._viewDate.clone()})},DateTimePicker.prototype._showMode=function(dir){this.widget&&(dir&&(this.currentViewMode=Math.max(this.MinViewModeNumber,Math.min(3,this.currentViewMode+dir))),this.widget.find(".datepicker > div").hide().filter(".datepicker-"+DatePickerModes[this.currentViewMode].CLASS_NAME).show())},DateTimePicker.prototype._isInDisabledDates=function(testDate){return this._options.disabledDates[testDate.format("YYYY-MM-DD")]===!0},DateTimePicker.prototype._isInEnabledDates=function(testDate){return this._options.enabledDates[testDate.format("YYYY-MM-DD")]===!0},DateTimePicker.prototype._isInDisabledHours=function(testDate){return this._options.disabledHours[testDate.format("H")]===!0},DateTimePicker.prototype._isInEnabledHours=function(testDate){return this._options.enabledHours[testDate.format("H")]===!0},DateTimePicker.prototype._isValid=function(targetMoment,granularity){if(!targetMoment.isValid()||this._options.disabledDates&&granularity==="d"&&this._isInDisabledDates(targetMoment)||this._options.enabledDates&&granularity==="d"&&!this._isInEnabledDates(targetMoment)||this._options.minDate&&targetMoment.isBefore(this._options.minDate,granularity)||this._options.maxDate&&targetMoment.isAfter(this._options.maxDate,granularity)||this._options.daysOfWeekDisabled&&granularity==="d"&&this._options.daysOfWeekDisabled.indexOf(targetMoment.day())!==-1||this._options.disabledHours&&(granularity==="h"||granularity==="m"||granularity==="s")&&this._isInDisabledHours(targetMoment)||this._options.enabledHours&&(granularity==="h"||granularity==="m"||granularity==="s")&&!this._isInEnabledHours(targetMoment))return!1;if(this._options.disabledTimeIntervals&&(granularity==="h"||granularity==="m"||granularity==="s")){var found=!1;if($.each(this._options.disabledTimeIntervals,function(){if(targetMoment.isBetween(this[0],this[1]))return found=!0,!1}),found)return!1}return!0},DateTimePicker.prototype._parseInputDate=function(inputDate){return this._options.parseInputDate===undefined?moment.isMoment(inputDate)||(inputDate=this.getMoment(inputDate)):inputDate=this._options.parseInputDate(inputDate),inputDate},DateTimePicker.prototype._keydown=function(e){var handler=null,index=void 0,index2=void 0,keyBindKeys=void 0,allModifiersPressed=void 0,pressedKeys=[],pressedModifiers={},currentKey=e.which,pressed="p";keyState[currentKey]=pressed;for(index in keyState)keyState.hasOwnProperty(index)&&keyState[index]===pressed&&(pressedKeys.push(index),parseInt(index,10)!==currentKey&&(pressedModifiers[index]=!0));for(index in this._options.keyBinds)if(this._options.keyBinds.hasOwnProperty(index)&&typeof this._options.keyBinds[index]=="function"&&(keyBindKeys=index.split(" "),keyBindKeys.length===pressedKeys.length&&KeyMap[currentKey]===keyBindKeys[keyBindKeys.length-1])){for(allModifiersPressed=!0,index2=keyBindKeys.length-2;index2>=0;index2--)if(!(KeyMap[keyBindKeys[index2]]in pressedModifiers)){allModifiersPressed=!1;break}if(allModifiersPressed){handler=this._options.keyBinds[index];break}}handler&&handler.call(this)&&(e.stopPropagation(),e.preventDefault())},DateTimePicker.prototype._keyup=function(e){keyState[e.which]="r";keyPressHandled[e.which]&&(keyPressHandled[e.which]=!1,e.stopPropagation(),e.preventDefault())},DateTimePicker.prototype._indexGivenDates=function(givenDatesArray){var givenDatesIndexed={},self=this;return $.each(givenDatesArray,function(){var dDate=self._parseInputDate(this);dDate.isValid()&&(givenDatesIndexed[dDate.format("YYYY-MM-DD")]=!0)}),Object.keys(givenDatesIndexed).length?givenDatesIndexed:!1},DateTimePicker.prototype._indexGivenHours=function(givenHoursArray){var givenHoursIndexed={};return $.each(givenHoursArray,function(){givenHoursIndexed[this]=!0}),Object.keys(givenHoursIndexed).length?givenHoursIndexed:!1},DateTimePicker.prototype._initFormatting=function(){var format=this._options.format||"L LT",self=this;this.actualFormat=format.replace(/(\[[^\[]*])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,function(formatInput){return self._dates[0].localeData().longDateFormat(formatInput)||formatInput});this.parseFormats=this._options.extraFormats?this._options.extraFormats.slice():[];this.parseFormats.indexOf(format)<0&&this.parseFormats.indexOf(this.actualFormat)<0&&this.parseFormats.push(this.actualFormat);this.use24Hours=this.actualFormat.toLowerCase().indexOf("a")<1&&this.actualFormat.replace(/\[.*?]/g,"").indexOf("h")<1;this._isEnabled("y")&&(this.MinViewModeNumber=2);this._isEnabled("M")&&(this.MinViewModeNumber=1);this._isEnabled("d")&&(this.MinViewModeNumber=0);this.currentViewMode=Math.max(this.MinViewModeNumber,this.currentViewMode);this.unset||this._setValue(this._dates[0],0)},DateTimePicker.prototype._getLastPickedDate=function(){return this._dates[this._getLastPickedDateIndex()]},DateTimePicker.prototype._getLastPickedDateIndex=function(){return this._dates.length-1},DateTimePicker.prototype.getMoment=function(d){var returnMoment=void 0;return returnMoment=d===undefined||d===null?moment():this._hasTimeZone()?moment.tz(d,this.parseFormats,this._options.locale,this._options.useStrict,this._options.timeZone):moment(d,this.parseFormats,this._options.locale,this._options.useStrict),this._hasTimeZone()&&returnMoment.tz(this._options.timeZone),returnMoment},DateTimePicker.prototype.toggle=function(){return this.widget?this.hide():this.show()},DateTimePicker.prototype.ignoreReadonly=function(_ignoreReadonly){if(arguments.length===0)return this._options.ignoreReadonly;if(typeof _ignoreReadonly!="boolean")throw new TypeError("ignoreReadonly () expects a boolean parameter");this._options.ignoreReadonly=_ignoreReadonly},DateTimePicker.prototype.options=function(newOptions){if(arguments.length===0)return $.extend(!0,{},this._options);if(!(newOptions instanceof Object))throw new TypeError("options() this.options parameter should be an object");$.extend(!0,this._options,newOptions);var self=this;$.each(this._options,function(key,value){self[key]!==undefined&&self[key](value)})},DateTimePicker.prototype.date=function(newDate,index){if(index=index||0,arguments.length===0)return this.unset?null:this._options.allowMultidate?this._dates.join(this._options.multidateSeparator):this._dates[index].clone();if(newDate!==null&&typeof newDate!="string"&&!moment.isMoment(newDate)&&!(newDate instanceof Date))throw new TypeError("date() parameter must be one of [null, string, moment or Date]");this._setValue(newDate===null?null:this._parseInputDate(newDate),index)},DateTimePicker.prototype.format=function(newFormat){if(arguments.length===0)return this._options.format;if(typeof newFormat!="string"&&(typeof newFormat!="boolean"||newFormat!==!1))throw new TypeError("format() expects a string or boolean:false parameter "+newFormat);this._options.format=newFormat;this.actualFormat&&this._initFormatting()},DateTimePicker.prototype.timeZone=function(newZone){if(arguments.length===0)return this._options.timeZone;if(typeof newZone!="string")throw new TypeError("newZone() expects a string parameter");this._options.timeZone=newZone},DateTimePicker.prototype.dayViewHeaderFormat=function(newFormat){if(arguments.length===0)return this._options.dayViewHeaderFormat;if(typeof newFormat!="string")throw new TypeError("dayViewHeaderFormat() expects a string parameter");this._options.dayViewHeaderFormat=newFormat},DateTimePicker.prototype.extraFormats=function(formats){if(arguments.length===0)return this._options.extraFormats;if(formats!==!1&&!(formats instanceof Array))throw new TypeError("extraFormats() expects an array or false parameter");this._options.extraFormats=formats;this.parseFormats&&this._initFormatting()},DateTimePicker.prototype.disabledDates=function(dates){if(arguments.length===0)return this._options.disabledDates?$.extend({},this._options.disabledDates):this._options.disabledDates;if(!dates)return this._options.disabledDates=!1,this._update(),!0;if(!(dates instanceof Array))throw new TypeError("disabledDates() expects an array parameter");this._options.disabledDates=this._indexGivenDates(dates);this._options.enabledDates=!1;this._update()},DateTimePicker.prototype.enabledDates=function(dates){if(arguments.length===0)return this._options.enabledDates?$.extend({},this._options.enabledDates):this._options.enabledDates;if(!dates)return this._options.enabledDates=!1,this._update(),!0;if(!(dates instanceof Array))throw new TypeError("enabledDates() expects an array parameter");this._options.enabledDates=this._indexGivenDates(dates);this._options.disabledDates=!1;this._update()},DateTimePicker.prototype.daysOfWeekDisabled=function(_daysOfWeekDisabled){var i,tries;if(arguments.length===0)return this._options.daysOfWeekDisabled.splice(0);if(typeof _daysOfWeekDisabled=="boolean"&&!_daysOfWeekDisabled)return this._options.daysOfWeekDisabled=!1,this._update(),!0;if(!(_daysOfWeekDisabled instanceof Array))throw new TypeError("daysOfWeekDisabled() expects an array parameter");if(this._options.daysOfWeekDisabled=_daysOfWeekDisabled.reduce(function(previousValue,currentValue){return(currentValue=parseInt(currentValue,10),currentValue>6||currentValue<0||isNaN(currentValue))?previousValue:(previousValue.indexOf(currentValue)===-1&&previousValue.push(currentValue),previousValue)},[]).sort(),this._options.useCurrent&&!this._options.keepInvalid)for(i=0;i<this._dates.length;i++){for(tries=0;!this._isValid(this._dates[i],"d");){if(this._dates[i].add(1,"d"),tries===31)throw"Tried 31 times to find a valid date";tries++}this._setValue(this._dates[i],i)}this._update()},DateTimePicker.prototype.maxDate=function(_maxDate){var parsedDate,i;if(arguments.length===0)return this._options.maxDate?this._options.maxDate.clone():this._options.maxDate;if(typeof _maxDate=="boolean"&&_maxDate===!1)return this._options.maxDate=!1,this._update(),!0;if(typeof _maxDate=="string"&&(_maxDate==="now"||_maxDate==="moment")&&(_maxDate=this.getMoment()),parsedDate=this._parseInputDate(_maxDate),!parsedDate.isValid())throw new TypeError("maxDate() Could not parse date parameter: "+_maxDate);if(this._options.minDate&&parsedDate.isBefore(this._options.minDate))throw new TypeError("maxDate() date parameter is before this.options.minDate: "+parsedDate.format(this.actualFormat));for(this._options.maxDate=parsedDate,i=0;i<this._dates.length;i++)this._options.useCurrent&&!this._options.keepInvalid&&this._dates[i].isAfter(_maxDate)&&this._setValue(this._options.maxDate,i);this._viewDate.isAfter(parsedDate)&&(this._viewDate=parsedDate.clone().subtract(this._options.stepping,"m"));this._update()},DateTimePicker.prototype.minDate=function(_minDate){var parsedDate,i;if(arguments.length===0)return this._options.minDate?this._options.minDate.clone():this._options.minDate;if(typeof _minDate=="boolean"&&_minDate===!1)return this._options.minDate=!1,this._update(),!0;if(typeof _minDate=="string"&&(_minDate==="now"||_minDate==="moment")&&(_minDate=this.getMoment()),parsedDate=this._parseInputDate(_minDate),!parsedDate.isValid())throw new TypeError("minDate() Could not parse date parameter: "+_minDate);if(this._options.maxDate&&parsedDate.isAfter(this._options.maxDate))throw new TypeError("minDate() date parameter is after this.options.maxDate: "+parsedDate.format(this.actualFormat));for(this._options.minDate=parsedDate,i=0;i<this._dates.length;i++)this._options.useCurrent&&!this._options.keepInvalid&&this._dates[i].isBefore(_minDate)&&this._setValue(this._options.minDate,i);this._viewDate.isBefore(parsedDate)&&(this._viewDate=parsedDate.clone().add(this._options.stepping,"m"));this._update()},DateTimePicker.prototype.defaultDate=function(_defaultDate){if(arguments.length===0)return this._options.defaultDate?this._options.defaultDate.clone():this._options.defaultDate;if(!_defaultDate)return this._options.defaultDate=!1,!0;typeof _defaultDate=="string"&&(_defaultDate=_defaultDate==="now"||_defaultDate==="moment"?this.getMoment():this.getMoment(_defaultDate));var parsedDate=this._parseInputDate(_defaultDate);if(!parsedDate.isValid())throw new TypeError("defaultDate() Could not parse date parameter: "+_defaultDate);if(!this._isValid(parsedDate))throw new TypeError("defaultDate() date passed is invalid according to component setup validations");this._options.defaultDate=parsedDate;(this._options.defaultDate&&this._options.inline||this.input!==undefined&&this.input.val().trim()==="")&&this._setValue(this._options.defaultDate,0)},DateTimePicker.prototype.locale=function(_locale){if(arguments.length===0)return this._options.locale;if(!moment.localeData(_locale))throw new TypeError("locale() locale "+_locale+" is not loaded from moment locales!");this._options.locale=_locale;for(var i=0;i<this._dates.length;i++)this._dates[i].locale(this._options.locale);this._viewDate.locale(this._options.locale);this.actualFormat&&this._initFormatting();this.widget&&(this.hide(),this.show())},DateTimePicker.prototype.stepping=function(_stepping){if(arguments.length===0)return this._options.stepping;_stepping=parseInt(_stepping,10);(isNaN(_stepping)||_stepping<1)&&(_stepping=1);this._options.stepping=_stepping},DateTimePicker.prototype.useCurrent=function(_useCurrent){var useCurrentOptions=["year","month","day","hour","minute"];if(arguments.length===0)return this._options.useCurrent;if(typeof _useCurrent!="boolean"&&typeof _useCurrent!="string")throw new TypeError("useCurrent() expects a boolean or string parameter");if(typeof _useCurrent=="string"&&useCurrentOptions.indexOf(_useCurrent.toLowerCase())===-1)throw new TypeError("useCurrent() expects a string parameter of "+useCurrentOptions.join(", "));this._options.useCurrent=_useCurrent},DateTimePicker.prototype.collapse=function(_collapse){if(arguments.length===0)return this._options.collapse;if(typeof _collapse!="boolean")throw new TypeError("collapse() expects a boolean parameter");if(this._options.collapse===_collapse)return!0;this._options.collapse=_collapse;this.widget&&(this.hide(),this.show())},DateTimePicker.prototype.icons=function(_icons){if(arguments.length===0)return $.extend({},this._options.icons);if(!(_icons instanceof Object))throw new TypeError("icons() expects parameter to be an Object");$.extend(this._options.icons,_icons);this.widget&&(this.hide(),this.show())},DateTimePicker.prototype.tooltips=function(_tooltips){if(arguments.length===0)return $.extend({},this._options.tooltips);if(!(_tooltips instanceof Object))throw new TypeError("tooltips() expects parameter to be an Object");$.extend(this._options.tooltips,_tooltips);this.widget&&(this.hide(),this.show())},DateTimePicker.prototype.useStrict=function(_useStrict){if(arguments.length===0)return this._options.useStrict;if(typeof _useStrict!="boolean")throw new TypeError("useStrict() expects a boolean parameter");this._options.useStrict=_useStrict},DateTimePicker.prototype.sideBySide=function(_sideBySide){if(arguments.length===0)return this._options.sideBySide;if(typeof _sideBySide!="boolean")throw new TypeError("sideBySide() expects a boolean parameter");this._options.sideBySide=_sideBySide;this.widget&&(this.hide(),this.show())},DateTimePicker.prototype.viewMode=function(_viewMode){if(arguments.length===0)return this._options.viewMode;if(typeof _viewMode!="string")throw new TypeError("viewMode() expects a string parameter");if(DateTimePicker.ViewModes.indexOf(_viewMode)===-1)throw new TypeError("viewMode() parameter must be one of ("+DateTimePicker.ViewModes.join(", ")+") value");this._options.viewMode=_viewMode;this.currentViewMode=Math.max(DateTimePicker.ViewModes.indexOf(_viewMode)-1,this.MinViewModeNumber);this._showMode()},DateTimePicker.prototype.calendarWeeks=function(_calendarWeeks){if(arguments.length===0)return this._options.calendarWeeks;if(typeof _calendarWeeks!="boolean")throw new TypeError("calendarWeeks() expects parameter to be a boolean value");this._options.calendarWeeks=_calendarWeeks;this._update()},DateTimePicker.prototype.buttons=function(_buttons){if(arguments.length===0)return $.extend({},this._options.buttons);if(!(_buttons instanceof Object))throw new TypeError("buttons() expects parameter to be an Object");if($.extend(this._options.buttons,_buttons),typeof this._options.buttons.showToday!="boolean")throw new TypeError("buttons.showToday expects a boolean parameter");if(typeof this._options.buttons.showClear!="boolean")throw new TypeError("buttons.showClear expects a boolean parameter");if(typeof this._options.buttons.showClose!="boolean")throw new TypeError("buttons.showClose expects a boolean parameter");this.widget&&(this.hide(),this.show())},DateTimePicker.prototype.keepOpen=function(_keepOpen){if(arguments.length===0)return this._options.keepOpen;if(typeof _keepOpen!="boolean")throw new TypeError("keepOpen() expects a boolean parameter");this._options.keepOpen=_keepOpen},DateTimePicker.prototype.focusOnShow=function(_focusOnShow){if(arguments.length===0)return this._options.focusOnShow;if(typeof _focusOnShow!="boolean")throw new TypeError("focusOnShow() expects a boolean parameter");this._options.focusOnShow=_focusOnShow},DateTimePicker.prototype.inline=function(_inline){if(arguments.length===0)return this._options.inline;if(typeof _inline!="boolean")throw new TypeError("inline() expects a boolean parameter");this._options.inline=_inline},DateTimePicker.prototype.clear=function(){this._setValue(null)},DateTimePicker.prototype.keyBinds=function(_keyBinds){if(arguments.length===0)return this._options.keyBinds;this._options.keyBinds=_keyBinds},DateTimePicker.prototype.debug=function(_debug){if(typeof _debug!="boolean")throw new TypeError("debug() expects a boolean parameter");this._options.debug=_debug},DateTimePicker.prototype.allowInputToggle=function(_allowInputToggle){if(arguments.length===0)return this._options.allowInputToggle;if(typeof _allowInputToggle!="boolean")throw new TypeError("allowInputToggle() expects a boolean parameter");this._options.allowInputToggle=_allowInputToggle},DateTimePicker.prototype.keepInvalid=function(_keepInvalid){if(arguments.length===0)return this._options.keepInvalid;if(typeof _keepInvalid!="boolean")throw new TypeError("keepInvalid() expects a boolean parameter");this._options.keepInvalid=_keepInvalid},DateTimePicker.prototype.datepickerInput=function(_datepickerInput){if(arguments.length===0)return this._options.datepickerInput;if(typeof _datepickerInput!="string")throw new TypeError("datepickerInput() expects a string parameter");this._options.datepickerInput=_datepickerInput},DateTimePicker.prototype.parseInputDate=function(_parseInputDate2){if(arguments.length===0)return this._options.parseInputDate;if(typeof _parseInputDate2!="function")throw new TypeError("parseInputDate() should be as function");this._options.parseInputDate=_parseInputDate2},DateTimePicker.prototype.disabledTimeIntervals=function(_disabledTimeIntervals){if(arguments.length===0)return this._options.disabledTimeIntervals?$.extend({},this._options.disabledTimeIntervals):this._options.disabledTimeIntervals;if(!_disabledTimeIntervals)return this._options.disabledTimeIntervals=!1,this._update(),!0;if(!(_disabledTimeIntervals instanceof Array))throw new TypeError("disabledTimeIntervals() expects an array parameter");this._options.disabledTimeIntervals=_disabledTimeIntervals;this._update()},DateTimePicker.prototype.disabledHours=function(hours){var i,tries;if(arguments.length===0)return this._options.disabledHours?$.extend({},this._options.disabledHours):this._options.disabledHours;if(!hours)return this._options.disabledHours=!1,this._update(),!0;if(!(hours instanceof Array))throw new TypeError("disabledHours() expects an array parameter");if(this._options.disabledHours=this._indexGivenHours(hours),this._options.enabledHours=!1,this._options.useCurrent&&!this._options.keepInvalid)for(i=0;i<this._dates.length;i++){for(tries=0;!this._isValid(this._dates[i],"h");){if(this._dates[i].add(1,"h"),tries===24)throw"Tried 24 times to find a valid date";tries++}this._setValue(this._dates[i],i)}this._update()},DateTimePicker.prototype.enabledHours=function(hours){var i,tries;if(arguments.length===0)return this._options.enabledHours?$.extend({},this._options.enabledHours):this._options.enabledHours;if(!hours)return this._options.enabledHours=!1,this._update(),!0;if(!(hours instanceof Array))throw new TypeError("enabledHours() expects an array parameter");if(this._options.enabledHours=this._indexGivenHours(hours),this._options.disabledHours=!1,this._options.useCurrent&&!this._options.keepInvalid)for(i=0;i<this._dates.length;i++){for(tries=0;!this._isValid(this._dates[i],"h");){if(this._dates[i].add(1,"h"),tries===24)throw"Tried 24 times to find a valid date";tries++}this._setValue(this._dates[i],i)}this._update()},DateTimePicker.prototype.viewDate=function(newDate){if(arguments.length===0)return this._viewDate.clone();if(!newDate)return this._viewDate=(this._dates[0]||this.getMoment()).clone(),!0;if(typeof newDate!="string"&&!moment.isMoment(newDate)&&!(newDate instanceof Date))throw new TypeError("viewDate() parameter must be one of [string, moment or Date]");this._viewDate=this._parseInputDate(newDate);this._viewUpdate()},DateTimePicker.prototype.allowMultidate=function(_allowMultidate){if(typeof _allowMultidate!="boolean")throw new TypeError("allowMultidate() expects a boolean parameter");this._options.allowMultidate=_allowMultidate},DateTimePicker.prototype.multidateSeparator=function(_multidateSeparator){if(arguments.length===0)return this._options.multidateSeparator;if(typeof _multidateSeparator!="string"||_multidateSeparator.length>1)throw new TypeError("multidateSeparator expects a single character string parameter");this._options.multidateSeparator=_multidateSeparator},_createClass(DateTimePicker,null,[{key:"NAME",get:function(){return NAME}},{key:"DATA_KEY",get:function(){return DATA_KEY}},{key:"EVENT_KEY",get:function(){return EVENT_KEY}},{key:"DATA_API_KEY",get:function(){return DATA_API_KEY}},{key:"DatePickerModes",get:function(){return DatePickerModes}},{key:"ViewModes",get:function(){return ViewModes}},{key:"Event",get:function(){return Event}},{key:"Selector",get:function(){return Selector}},{key:"Default",get:function(){return Default},set:function(value){Default=value}},{key:"ClassName",get:function(){return ClassName}}]),DateTimePicker}()}(jQuery,moment),TempusDominusBootstrap4=function($){var JQUERY_NO_CONFLICT=$.fn[DateTimePicker.NAME],verticalModes=["top","bottom","auto"],horizontalModes=["left","right","auto"],toolbarPlacements=["default","top","bottom"],getSelectorFromElement=function($element){var selector=$element.data("target"),$selector=void 0;return(selector||(selector=$element.attr("href")||"",selector=/^#[a-z]/i.test(selector)?selector:null),$selector=$(selector),$selector.length===0)?$selector:($selector.data(DateTimePicker.DATA_KEY)||$.extend({},$selector.data(),$(this).data()),$selector)},TempusDominusBootstrap4=function(_DateTimePicker){function TempusDominusBootstrap4(element,options){_classCallCheck(this,TempusDominusBootstrap4);var _this=_possibleConstructorReturn(this,_DateTimePicker.call(this,element,options));return _this._init(),_this}return _inherits(TempusDominusBootstrap4,_DateTimePicker),TempusDominusBootstrap4.prototype._init=function(){if(this._element.hasClass("input-group")){var datepickerButton=this._element.find(".datepickerbutton");this.component=datepickerButton.length===0?this._element.find('[data-toggle="datetimepicker"]'):datepickerButton}},TempusDominusBootstrap4.prototype._getDatePickerTemplate=function(){var headTemplate=$("<thead>").append($("<tr>").append($("<th>").addClass("prev").attr("data-action","previous").append($("<span>").addClass(this._options.icons.previous))).append($("<th>").addClass("picker-switch").attr("data-action","pickerSwitch").attr("colspan",""+(this._options.calendarWeeks?"6":"5"))).append($("<th>").addClass("next").attr("data-action","next").append($("<span>").addClass(this._options.icons.next)))),contTemplate=$("<tbody>").append($("<tr>").append($("<td>").attr("colspan",""+(this._options.calendarWeeks?"8":"7"))));return[$("<div>").addClass("datepicker-days").append($("<table>").addClass("table table-sm").append(headTemplate).append($("<tbody>"))),$("<div>").addClass("datepicker-months").append($("<table>").addClass("table-condensed").append(headTemplate.clone()).append(contTemplate.clone())),$("<div>").addClass("datepicker-years").append($("<table>").addClass("table-condensed").append(headTemplate.clone()).append(contTemplate.clone())),$("<div>").addClass("datepicker-decades").append($("<table>").addClass("table-condensed").append(headTemplate.clone()).append(contTemplate.clone()))]},TempusDominusBootstrap4.prototype._getTimePickerMainTemplate=function(){var topRow=$("<tr>"),middleRow=$("<tr>"),bottomRow=$("<tr>");return this._isEnabled("h")&&(topRow.append($("<td>").append($("<a>").attr({href:"#",tabindex:"-1",title:this._options.tooltips.incrementHour}).addClass("btn").attr("data-action","incrementHours").append($("<span>").addClass(this._options.icons.up)))),middleRow.append($("<td>").append($("<span>").addClass("timepicker-hour").attr({"data-time-component":"hours",title:this._options.tooltips.pickHour}).attr("data-action","showHours"))),bottomRow.append($("<td>").append($("<a>").attr({href:"#",tabindex:"-1",title:this._options.tooltips.decrementHour}).addClass("btn").attr("data-action","decrementHours").append($("<span>").addClass(this._options.icons.down))))),this._isEnabled("m")&&(this._isEnabled("h")&&(topRow.append($("<td>").addClass("separator")),middleRow.append($("<td>").addClass("separator").html(":")),bottomRow.append($("<td>").addClass("separator"))),topRow.append($("<td>").append($("<a>").attr({href:"#",tabindex:"-1",title:this._options.tooltips.incrementMinute}).addClass("btn").attr("data-action","incrementMinutes").append($("<span>").addClass(this._options.icons.up)))),middleRow.append($("<td>").append($("<span>").addClass("timepicker-minute").attr({"data-time-component":"minutes",title:this._options.tooltips.pickMinute}).attr("data-action","showMinutes"))),bottomRow.append($("<td>").append($("<a>").attr({href:"#",tabindex:"-1",title:this._options.tooltips.decrementMinute}).addClass("btn").attr("data-action","decrementMinutes").append($("<span>").addClass(this._options.icons.down))))),this._isEnabled("s")&&(this._isEnabled("m")&&(topRow.append($("<td>").addClass("separator")),middleRow.append($("<td>").addClass("separator").html(":")),bottomRow.append($("<td>").addClass("separator"))),topRow.append($("<td>").append($("<a>").attr({href:"#",tabindex:"-1",title:this._options.tooltips.incrementSecond}).addClass("btn").attr("data-action","incrementSeconds").append($("<span>").addClass(this._options.icons.up)))),middleRow.append($("<td>").append($("<span>").addClass("timepicker-second").attr({"data-time-component":"seconds",title:this._options.tooltips.pickSecond}).attr("data-action","showSeconds"))),bottomRow.append($("<td>").append($("<a>").attr({href:"#",tabindex:"-1",title:this._options.tooltips.decrementSecond}).addClass("btn").attr("data-action","decrementSeconds").append($("<span>").addClass(this._options.icons.down))))),this.use24Hours||(topRow.append($("<td>").addClass("separator")),middleRow.append($("<td>").append($("<button>").addClass("btn btn-primary").attr({"data-action":"togglePeriod",tabindex:"-1",title:this._options.tooltips.togglePeriod}))),bottomRow.append($("<td>").addClass("separator"))),$("<div>").addClass("timepicker-picker").append($("<table>").addClass("table-condensed").append([topRow,middleRow,bottomRow]))},TempusDominusBootstrap4.prototype._getTimePickerTemplate=function(){var hoursView=$("<div>").addClass("timepicker-hours").append($("<table>").addClass("table-condensed")),minutesView=$("<div>").addClass("timepicker-minutes").append($("<table>").addClass("table-condensed")),secondsView=$("<div>").addClass("timepicker-seconds").append($("<table>").addClass("table-condensed")),ret=[this._getTimePickerMainTemplate()];return this._isEnabled("h")&&ret.push(hoursView),this._isEnabled("m")&&ret.push(minutesView),this._isEnabled("s")&&ret.push(secondsView),ret},TempusDominusBootstrap4.prototype._getToolbar=function(){var row=[],title,icon;return this._options.buttons.showToday&&row.push($("<td>").append($("<a>").attr({href:"#",tabindex:"-1","data-action":"today",title:this._options.tooltips.today}).append($("<span>").addClass(this._options.icons.today)))),!this._options.sideBySide&&this._hasDate()&&this._hasTime()&&(title=void 0,icon=void 0,this._options.viewMode==="times"?(title=this._options.tooltips.selectDate,icon=this._options.icons.date):(title=this._options.tooltips.selectTime,icon=this._options.icons.time),row.push($("<td>").append($("<a>").attr({href:"#",tabindex:"-1","data-action":"togglePicker",title:title}).append($("<span>").addClass(icon))))),this._options.buttons.showClear&&row.push($("<td>").append($("<a>").attr({href:"#",tabindex:"-1","data-action":"clear",title:this._options.tooltips.clear}).append($("<span>").addClass(this._options.icons.clear)))),this._options.buttons.showClose&&row.push($("<td>").append($("<a>").attr({href:"#",tabindex:"-1","data-action":"close",title:this._options.tooltips.close}).append($("<span>").addClass(this._options.icons.close)))),row.length===0?"":$("<table>").addClass("table-condensed").append($("<tbody>").append($("<tr>").append(row)))},TempusDominusBootstrap4.prototype._getTemplate=function(){var template=$("<div>").addClass("bootstrap-datetimepicker-widget dropdown-menu"),dateView=$("<div>").addClass("datepicker").append(this._getDatePickerTemplate()),timeView=$("<div>").addClass("timepicker").append(this._getTimePickerTemplate()),content=$("<ul>").addClass("list-unstyled"),toolbar=$("<li>").addClass("picker-switch"+(this._options.collapse?" accordion-toggle":"")).append(this._getToolbar());return(this._options.inline&&template.removeClass("dropdown-menu"),this.use24Hours&&template.addClass("usetwentyfour"),this._isEnabled("s")&&!this.use24Hours&&template.addClass("wider"),this._options.sideBySide&&this._hasDate()&&this._hasTime())?(template.addClass("timepicker-sbs"),this._options.toolbarPlacement==="top"&&template.append(toolbar),template.append($("<div>").addClass("row").append(dateView.addClass("col-md-6")).append(timeView.addClass("col-md-6"))),(this._options.toolbarPlacement==="bottom"||this._options.toolbarPlacement==="default")&&template.append(toolbar),template):(this._options.toolbarPlacement==="top"&&content.append(toolbar),this._hasDate()&&content.append($("<li>").addClass(this._options.collapse&&this._hasTime()?"collapse":"").addClass(this._options.collapse&&this._hasTime()&&this._options.viewMode==="times"?"":"show").append(dateView)),this._options.toolbarPlacement==="default"&&content.append(toolbar),this._hasTime()&&content.append($("<li>").addClass(this._options.collapse&&this._hasDate()?"collapse":"").addClass(this._options.collapse&&this._hasDate()&&this._options.viewMode==="times"?"show":"").append(timeView)),this._options.toolbarPlacement==="bottom"&&content.append(toolbar),template.append(content))},TempusDominusBootstrap4.prototype._place=function(e){var self=e&&e.data&&e.data.picker||this,vertical=self._options.widgetPositioning.vertical,horizontal=self._options.widgetPositioning.horizontal,parent=void 0,position=(self.component&&self.component.length?self.component:self._element).position(),offset=(self.component&&self.component.length?self.component:self._element).offset();if(self._options.widgetParent)parent=self._options.widgetParent.append(self.widget);else if(self._element.is("input"))parent=self._element.after(self.widget).parent();else{if(self._options.inline){parent=self._element.append(self.widget);return}parent=self._element;self._element.children().first().after(self.widget)}if(vertical==="auto"&&(vertical=offset.top+self.widget.height()*1.5>=$(window).height()+$(window).scrollTop()&&self.widget.height()+self._element.outerHeight()<offset.top?"top":"bottom"),horizontal==="auto"&&(horizontal=parent.width()<offset.left+self.widget.outerWidth()/2&&offset.left+self.widget.outerWidth()>$(window).width()?"right":"left"),vertical==="top"?self.widget.addClass("top").removeClass("bottom"):self.widget.addClass("bottom").removeClass("top"),horizontal==="right"?self.widget.addClass("float-right"):self.widget.removeClass("float-right"),parent.css("position")!=="relative"&&(parent=parent.parents().filter(function(){return $(this).css("position")==="relative"}).first()),parent.length===0)throw new Error("datetimepicker component should be placed within a relative positioned container");self.widget.css({top:vertical==="top"?"auto":position.top+self._element.outerHeight()+"px",bottom:vertical==="top"?parent.outerHeight()-(parent===self._element?0:position.top)+"px":"auto",left:horizontal==="left"?(parent===self._element?0:position.left)+"px":"auto",right:horizontal==="left"?"auto":parent.outerWidth()-self._element.outerWidth()-(parent===self._element?0:position.left)+"px"})},TempusDominusBootstrap4.prototype._fillDow=function(){var row=$("<tr>"),currentDate=this._viewDate.clone().startOf("w").startOf("d");for(this._options.calendarWeeks===!0&&row.append($("<th>").addClass("cw").text("#"));currentDate.isBefore(this._viewDate.clone().endOf("w"));)row.append($("<th>").addClass("dow").text(currentDate.format("dd"))),currentDate.add(1,"d");this.widget.find(".datepicker-days thead").append(row)},TempusDominusBootstrap4.prototype._fillMonths=function(){for(var spans=[],monthsShort=this._viewDate.clone().startOf("y").startOf("d");monthsShort.isSame(this._viewDate,"y");)spans.push($("<span>").attr("data-action","selectMonth").addClass("month").text(monthsShort.format("MMM"))),monthsShort.add(1,"M");this.widget.find(".datepicker-months td").empty().append(spans)},TempusDominusBootstrap4.prototype._updateMonths=function(){var monthsView=this.widget.find(".datepicker-months"),monthsViewHeader=monthsView.find("th"),months=monthsView.find("tbody").find("span"),self=this;monthsViewHeader.eq(0).find("span").attr("title",this._options.tooltips.prevYear);monthsViewHeader.eq(1).attr("title",this._options.tooltips.selectYear);monthsViewHeader.eq(2).find("span").attr("title",this._options.tooltips.nextYear);monthsView.find(".disabled").removeClass("disabled");this._isValid(this._viewDate.clone().subtract(1,"y"),"y")||monthsViewHeader.eq(0).addClass("disabled");monthsViewHeader.eq(1).text(this._viewDate.year());this._isValid(this._viewDate.clone().add(1,"y"),"y")||monthsViewHeader.eq(2).addClass("disabled");months.removeClass("active");this._getLastPickedDate().isSame(this._viewDate,"y")&&!this.unset&&months.eq(this._getLastPickedDate().month()).addClass("active");months.each(function(index){self._isValid(self._viewDate.clone().month(index),"M")||$(this).addClass("disabled")})},TempusDominusBootstrap4.prototype._getStartEndYear=function(factor,year){var step=factor/10,startYear=Math.floor(year/factor)*factor,endYear=startYear+step*9,focusValue=Math.floor(year/step)*step;return[startYear,endYear,focusValue]},TempusDominusBootstrap4.prototype._updateYears=function(){var yearsView=this.widget.find(".datepicker-years"),yearsViewHeader=yearsView.find("th"),yearCaps=this._getStartEndYear(10,this._viewDate.year()),startYear=this._viewDate.clone().year(yearCaps[0]),endYear=this._viewDate.clone().year(yearCaps[1]),html="";for(yearsViewHeader.eq(0).find("span").attr("title",this._options.tooltips.prevDecade),yearsViewHeader.eq(1).attr("title",this._options.tooltips.selectDecade),yearsViewHeader.eq(2).find("span").attr("title",this._options.tooltips.nextDecade),yearsView.find(".disabled").removeClass("disabled"),this._options.minDate&&this._options.minDate.isAfter(startYear,"y")&&yearsViewHeader.eq(0).addClass("disabled"),yearsViewHeader.eq(1).text(startYear.year()+"-"+endYear.year()),this._options.maxDate&&this._options.maxDate.isBefore(endYear,"y")&&yearsViewHeader.eq(2).addClass("disabled"),html+='<span data-action="selectYear" class="year old'+(this._isValid(startYear,"y")?"":" disabled")+'">'+(startYear.year()-1)+"<\/span>";!startYear.isAfter(endYear,"y");)html+='<span data-action="selectYear" class="year'+(startYear.isSame(this._getLastPickedDate(),"y")&&!this.unset?" active":"")+(this._isValid(startYear,"y")?"":" disabled")+'">'+startYear.year()+"<\/span>",startYear.add(1,"y");html+='<span data-action="selectYear" class="year old'+(this._isValid(startYear,"y")?"":" disabled")+'">'+startYear.year()+"<\/span>";yearsView.find("td").html(html)},TempusDominusBootstrap4.prototype._updateDecades=function(){var decadesView=this.widget.find(".datepicker-decades"),decadesViewHeader=decadesView.find("th"),yearCaps=this._getStartEndYear(100,this._viewDate.year()),startDecade=this._viewDate.clone().year(yearCaps[0]),endDecade=this._viewDate.clone().year(yearCaps[1]),minDateDecade=!1,maxDateDecade=!1,endDecadeYear=void 0,html="";for(decadesViewHeader.eq(0).find("span").attr("title",this._options.tooltips.prevCentury),decadesViewHeader.eq(2).find("span").attr("title",this._options.tooltips.nextCentury),decadesView.find(".disabled").removeClass("disabled"),(startDecade.year()===0||this._options.minDate&&this._options.minDate.isAfter(startDecade,"y"))&&decadesViewHeader.eq(0).addClass("disabled"),decadesViewHeader.eq(1).text(startDecade.year()+"-"+endDecade.year()),this._options.maxDate&&this._options.maxDate.isBefore(endDecade,"y")&&decadesViewHeader.eq(2).addClass("disabled"),html+=startDecade.year()-10<0?"<span>&nbsp;<\/span>":'<span data-action="selectDecade" class="decade old" data-selection="'+(startDecade.year()+6)+'">'+(startDecade.year()-10)+"<\/span>";!startDecade.isAfter(endDecade,"y");)endDecadeYear=startDecade.year()+11,minDateDecade=this._options.minDate&&this._options.minDate.isAfter(startDecade,"y")&&this._options.minDate.year()<=endDecadeYear,maxDateDecade=this._options.maxDate&&this._options.maxDate.isAfter(startDecade,"y")&&this._options.maxDate.year()<=endDecadeYear,html+='<span data-action="selectDecade" class="decade'+(this._getLastPickedDate().isAfter(startDecade)&&this._getLastPickedDate().year()<=endDecadeYear?" active":"")+(!this._isValid(startDecade,"y")&&!minDateDecade&&!maxDateDecade?" disabled":"")+'" data-selection="'+(startDecade.year()+6)+'">'+startDecade.year()+"<\/span>",startDecade.add(10,"y");html+='<span data-action="selectDecade" class="decade old" data-selection="'+(startDecade.year()+6)+'">'+startDecade.year()+"<\/span>";decadesView.find("td").html(html)},TempusDominusBootstrap4.prototype._fillDate=function(){var daysView=this.widget.find(".datepicker-days"),daysViewHeader=daysView.find("th"),html=[],currentDate=void 0,row=void 0,clsName=void 0,i=void 0,index;if(this._hasDate()){for(daysViewHeader.eq(0).find("span").attr("title",this._options.tooltips.prevMonth),daysViewHeader.eq(1).attr("title",this._options.tooltips.selectMonth),daysViewHeader.eq(2).find("span").attr("title",this._options.tooltips.nextMonth),daysView.find(".disabled").removeClass("disabled"),daysViewHeader.eq(1).text(this._viewDate.format(this._options.dayViewHeaderFormat)),this._isValid(this._viewDate.clone().subtract(1,"M"),"M")||daysViewHeader.eq(0).addClass("disabled"),this._isValid(this._viewDate.clone().add(1,"M"),"M")||daysViewHeader.eq(2).addClass("disabled"),currentDate=this._viewDate.clone().startOf("M").startOf("w").startOf("d"),i=0;i<42;i++)currentDate.weekday()===0&&(row=$("<tr>"),this._options.calendarWeeks&&row.append('<td class="cw">'+currentDate.week()+"<\/td>"),html.push(row)),clsName="",currentDate.isBefore(this._viewDate,"M")&&(clsName+=" old"),currentDate.isAfter(this._viewDate,"M")&&(clsName+=" new"),this._options.allowMultidate?(index=this._datesFormatted.indexOf(currentDate.format("YYYY-MM-DD")),index!==-1&&currentDate.isSame(this._datesFormatted[index],"d")&&!this.unset&&(clsName+=" active")):currentDate.isSame(this._getLastPickedDate(),"d")&&!this.unset&&(clsName+=" active"),this._isValid(currentDate,"d")||(clsName+=" disabled"),currentDate.isSame(this.getMoment(),"d")&&(clsName+=" today"),(currentDate.day()===0||currentDate.day()===6)&&(clsName+=" weekend"),row.append('<td data-action="selectDay" data-day="'+currentDate.format("L")+'" class="day'+clsName+'">'+currentDate.date()+"<\/td>"),currentDate.add(1,"d");daysView.find("tbody").empty().append(html);this._updateMonths();this._updateYears();this._updateDecades()}},TempusDominusBootstrap4.prototype._fillHours=function(){var table=this.widget.find(".timepicker-hours table"),currentHour=this._viewDate.clone().startOf("d"),html=[],row=$("<tr>");for(this._viewDate.hour()>11&&!this.use24Hours&&currentHour.hour(12);currentHour.isSame(this._viewDate,"d")&&(this.use24Hours||this._viewDate.hour()<12&&currentHour.hour()<12||this._viewDate.hour()>11);)currentHour.hour()%4==0&&(row=$("<tr>"),html.push(row)),row.append('<td data-action="selectHour" class="hour'+(this._isValid(currentHour,"h")?"":" disabled")+'">'+currentHour.format(this.use24Hours?"HH":"hh")+"<\/td>"),currentHour.add(1,"h");table.empty().append(html)},TempusDominusBootstrap4.prototype._fillMinutes=function(){for(var table=this.widget.find(".timepicker-minutes table"),currentMinute=this._viewDate.clone().startOf("h"),html=[],step=this._options.stepping===1?5:this._options.stepping,row=$("<tr>");this._viewDate.isSame(currentMinute,"h");)currentMinute.minute()%(step*4)==0&&(row=$("<tr>"),html.push(row)),row.append('<td data-action="selectMinute" class="minute'+(this._isValid(currentMinute,"m")?"":" disabled")+'">'+currentMinute.format("mm")+"<\/td>"),currentMinute.add(step,"m");table.empty().append(html)},TempusDominusBootstrap4.prototype._fillSeconds=function(){for(var table=this.widget.find(".timepicker-seconds table"),currentSecond=this._viewDate.clone().startOf("m"),html=[],row=$("<tr>");this._viewDate.isSame(currentSecond,"m");)currentSecond.second()%20==0&&(row=$("<tr>"),html.push(row)),row.append('<td data-action="selectSecond" class="second'+(this._isValid(currentSecond,"s")?"":" disabled")+'">'+currentSecond.format("ss")+"<\/td>"),currentSecond.add(5,"s");table.empty().append(html)},TempusDominusBootstrap4.prototype._fillTime=function(){var toggle=void 0,newDate=void 0,timeComponents=this.widget.find(".timepicker span[data-time-component]");this.use24Hours||(toggle=this.widget.find(".timepicker [data-action=togglePeriod]"),newDate=this._getLastPickedDate().clone().add(this._getLastPickedDate().hours()>=12?-12:12,"h"),toggle.text(this._getLastPickedDate().format("A")),this._isValid(newDate,"h")?toggle.removeClass("disabled"):toggle.addClass("disabled"));timeComponents.filter("[data-time-component=hours]").text(this._getLastPickedDate().format(""+(this.use24Hours?"HH":"hh")));timeComponents.filter("[data-time-component=minutes]").text(this._getLastPickedDate().format("mm"));timeComponents.filter("[data-time-component=seconds]").text(this._getLastPickedDate().format("ss"));this._fillHours();this._fillMinutes();this._fillSeconds()},TempusDominusBootstrap4.prototype._doAction=function(e,action){var lastPicked=this._getLastPickedDate(),navFnc,_navFnc,month,year,_year,day,selectDate,index,newDate,_newDate,_newDate2,_newDate3,_newDate4,_newDate5,hour,todaysDate;if($(e.currentTarget).is(".disabled"))return!1;action=action||$(e.currentTarget).data("action");switch(action){case"next":navFnc=DateTimePicker.DatePickerModes[this.currentViewMode].NAV_FUNCTION;this._viewDate.add(DateTimePicker.DatePickerModes[this.currentViewMode].NAV_STEP,navFnc);this._fillDate();this._viewUpdate(navFnc);break;case"previous":_navFnc=DateTimePicker.DatePickerModes[this.currentViewMode].NAV_FUNCTION;this._viewDate.subtract(DateTimePicker.DatePickerModes[this.currentViewMode].NAV_STEP,_navFnc);this._fillDate();this._viewUpdate(_navFnc);break;case"pickerSwitch":this._showMode(1);break;case"selectMonth":month=$(e.target).closest("tbody").find("span").index($(e.target));this._viewDate.month(month);this.currentViewMode===this.MinViewModeNumber?(this._setValue(lastPicked.clone().year(this._viewDate.year()).month(this._viewDate.month()),this._getLastPickedDateIndex()),this._options.inline||this.hide()):(this._showMode(-1),this._fillDate());this._viewUpdate("M");break;case"selectYear":year=parseInt($(e.target).text(),10)||0;this._viewDate.year(year);this.currentViewMode===this.MinViewModeNumber?(this._setValue(lastPicked.clone().year(this._viewDate.year()),this._getLastPickedDateIndex()),this._options.inline||this.hide()):(this._showMode(-1),this._fillDate());this._viewUpdate("YYYY");break;case"selectDecade":_year=parseInt($(e.target).data("selection"),10)||0;this._viewDate.year(_year);this.currentViewMode===this.MinViewModeNumber?(this._setValue(lastPicked.clone().year(this._viewDate.year()),this._getLastPickedDateIndex()),this._options.inline||this.hide()):(this._showMode(-1),this._fillDate());this._viewUpdate("YYYY");break;case"selectDay":day=this._viewDate.clone();$(e.target).is(".old")&&day.subtract(1,"M");$(e.target).is(".new")&&day.add(1,"M");selectDate=day.date(parseInt($(e.target).text(),10));index=0;this._options.allowMultidate?(index=this._datesFormatted.indexOf(selectDate.format("YYYY-MM-DD")),index!==-1?this._setValue(null,index):this._setValue(selectDate,this._getLastPickedDateIndex()+1)):this._setValue(selectDate,this._getLastPickedDateIndex());this._hasTime()||this._options.keepOpen||this._options.inline||this._options.allowMultidate||this.hide();break;case"incrementHours":newDate=lastPicked.clone().add(1,"h");this._isValid(newDate,"h")&&this._setValue(newDate,this._getLastPickedDateIndex());break;case"incrementMinutes":_newDate=lastPicked.clone().add(this._options.stepping,"m");this._isValid(_newDate,"m")&&this._setValue(_newDate,this._getLastPickedDateIndex());break;case"incrementSeconds":_newDate2=lastPicked.clone().add(1,"s");this._isValid(_newDate2,"s")&&this._setValue(_newDate2,this._getLastPickedDateIndex());break;case"decrementHours":_newDate3=lastPicked.clone().subtract(1,"h");this._isValid(_newDate3,"h")&&this._setValue(_newDate3,this._getLastPickedDateIndex());break;case"decrementMinutes":_newDate4=lastPicked.clone().subtract(this._options.stepping,"m");this._isValid(_newDate4,"m")&&this._setValue(_newDate4,this._getLastPickedDateIndex());break;case"decrementSeconds":_newDate5=lastPicked.clone().subtract(1,"s");this._isValid(_newDate5,"s")&&this._setValue(_newDate5,this._getLastPickedDateIndex());break;case"togglePeriod":this._setValue(lastPicked.clone().add(lastPicked.hours()>=12?-12:12,"h"),this._getLastPickedDateIndex());break;case"togglePicker":var $this=$(e.target),$link=$this.closest("a"),$parent=$this.closest("ul"),expanded=$parent.find(".show"),closed=$parent.find(".collapse:not(.show)"),$span=$this.is("span")?$this:$this.find("span"),collapseData=void 0;if(expanded&&expanded.length){if(collapseData=expanded.data("collapse"),collapseData&&collapseData.transitioning)return!0;expanded.collapse?(expanded.collapse("hide"),closed.collapse("show")):(expanded.removeClass("show"),closed.addClass("show"));$span.toggleClass(this._options.icons.time+" "+this._options.icons.date);$span.hasClass(this._options.icons.date)?$link.attr("title",this._options.tooltips.selectDate):$link.attr("title",this._options.tooltips.selectTime)}break;case"showPicker":this.widget.find(".timepicker > div:not(.timepicker-picker)").hide();this.widget.find(".timepicker .timepicker-picker").show();break;case"showHours":this.widget.find(".timepicker .timepicker-picker").hide();this.widget.find(".timepicker .timepicker-hours").show();break;case"showMinutes":this.widget.find(".timepicker .timepicker-picker").hide();this.widget.find(".timepicker .timepicker-minutes").show();break;case"showSeconds":this.widget.find(".timepicker .timepicker-picker").hide();this.widget.find(".timepicker .timepicker-seconds").show();break;case"selectHour":hour=parseInt($(e.target).text(),10);this.use24Hours||(lastPicked.hours()>=12?hour!==12&&(hour+=12):hour===12&&(hour=0));this._setValue(lastPicked.clone().hours(hour),this._getLastPickedDateIndex());this._isEnabled("a")||this._isEnabled("m")||this._options.keepOpen||this._options.inline?this._doAction(e,"showPicker"):this.hide();break;case"selectMinute":this._setValue(lastPicked.clone().minutes(parseInt($(e.target).text(),10)),this._getLastPickedDateIndex());this._isEnabled("a")||this._isEnabled("s")||this._options.keepOpen||this._options.inline?this._doAction(e,"showPicker"):this.hide();break;case"selectSecond":this._setValue(lastPicked.clone().seconds(parseInt($(e.target).text(),10)),this._getLastPickedDateIndex());this._isEnabled("a")||this._options.keepOpen||this._options.inline?this._doAction(e,"showPicker"):this.hide();break;case"clear":this.clear();break;case"close":this.hide();break;case"today":todaysDate=this.getMoment();this._isValid(todaysDate,"d")&&this._setValue(todaysDate,this._getLastPickedDateIndex())}return!1},TempusDominusBootstrap4.prototype.hide=function(){var transitioning=!1;this.widget&&((this.widget.find(".collapse").each(function(){var collapseData=$(this).data("collapse");return collapseData&&collapseData.transitioning?(transitioning=!0,!1):!0}),transitioning)||(this.component&&this.component.hasClass("btn")&&this.component.toggleClass("active"),this.widget.hide(),$(window).off("resize",this._place()),this.widget.off("click","[data-action]"),this.widget.off("mousedown",!1),this.widget.remove(),this.widget=!1,this._notifyEvent({type:DateTimePicker.Event.HIDE,date:this._getLastPickedDate().clone()}),this.input!==undefined&&this.input.blur(),this._viewDate=this._getLastPickedDate().clone()))},TempusDominusBootstrap4.prototype.show=function(){var currentMoment=void 0,useCurrentGranularity={year:function(m){return m.month(0).date(1).hours(0).seconds(0).minutes(0)},month:function(m){return m.date(1).hours(0).seconds(0).minutes(0)},day:function(m){return m.hours(0).seconds(0).minutes(0)},hour:function(m){return m.seconds(0).minutes(0)},minute:function(m){return m.seconds(0)}};if(this.input!==undefined){if(this.input.prop("disabled")||!this._options.ignoreReadonly&&this.input.prop("readonly")||this.widget)return;this.input.val()!==undefined&&this.input.val().trim().length!==0?this._setValue(this._parseInputDate(this.input.val().trim()),0):this.unset&&this._options.useCurrent&&(currentMoment=this.getMoment(),typeof this._options.useCurrent=="string"&&(currentMoment=useCurrentGranularity[this._options.useCurrent](currentMoment)),this._setValue(currentMoment,0))}else this.unset&&this._options.useCurrent&&(currentMoment=this.getMoment(),typeof this._options.useCurrent=="string"&&(currentMoment=useCurrentGranularity[this._options.useCurrent](currentMoment)),this._setValue(currentMoment,0));this.widget=this._getTemplate();this._fillDow();this._fillMonths();this.widget.find(".timepicker-hours").hide();this.widget.find(".timepicker-minutes").hide();this.widget.find(".timepicker-seconds").hide();this._update();this._showMode();$(window).on("resize",{picker:this},this._place);this.widget.on("click","[data-action]",$.proxy(this._doAction,this));this.widget.on("mousedown",!1);this.component&&this.component.hasClass("btn")&&this.component.toggleClass("active");this._place();this.widget.show();this.input!==undefined&&this._options.focusOnShow&&!this.input.is(":focus")&&this.input.focus();this._notifyEvent({type:DateTimePicker.Event.SHOW})},TempusDominusBootstrap4.prototype.destroy=function(){this.hide();this._element.removeData(DateTimePicker.DATA_KEY);this._element.removeData("date")},TempusDominusBootstrap4.prototype.disable=function(){this.hide();this.component&&this.component.hasClass("btn")&&this.component.addClass("disabled");this.input!==undefined&&this.input.prop("disabled",!0)},TempusDominusBootstrap4.prototype.enable=function(){this.component&&this.component.hasClass("btn")&&this.component.removeClass("disabled");this.input!==undefined&&this.input.prop("disabled",!1)},TempusDominusBootstrap4.prototype.toolbarPlacement=function(_toolbarPlacement){if(arguments.length===0)return this._options.toolbarPlacement;if(typeof _toolbarPlacement!="string")throw new TypeError("toolbarPlacement() expects a string parameter");if(toolbarPlacements.indexOf(_toolbarPlacement)===-1)throw new TypeError("toolbarPlacement() parameter must be one of ("+toolbarPlacements.join(", ")+") value");this._options.toolbarPlacement=_toolbarPlacement;this.widget&&(this.hide(),this.show())},TempusDominusBootstrap4.prototype.widgetPositioning=function(_widgetPositioning){if(arguments.length===0)return $.extend({},this._options.widgetPositioning);if({}.toString.call(_widgetPositioning)!=="[object Object]")throw new TypeError("widgetPositioning() expects an object variable");if(_widgetPositioning.horizontal){if(typeof _widgetPositioning.horizontal!="string")throw new TypeError("widgetPositioning() horizontal variable must be a string");if(_widgetPositioning.horizontal=_widgetPositioning.horizontal.toLowerCase(),horizontalModes.indexOf(_widgetPositioning.horizontal)===-1)throw new TypeError("widgetPositioning() expects horizontal parameter to be one of ("+horizontalModes.join(", ")+")");this._options.widgetPositioning.horizontal=_widgetPositioning.horizontal}if(_widgetPositioning.vertical){if(typeof _widgetPositioning.vertical!="string")throw new TypeError("widgetPositioning() vertical variable must be a string");if(_widgetPositioning.vertical=_widgetPositioning.vertical.toLowerCase(),verticalModes.indexOf(_widgetPositioning.vertical)===-1)throw new TypeError("widgetPositioning() expects vertical parameter to be one of ("+verticalModes.join(", ")+")");this._options.widgetPositioning.vertical=_widgetPositioning.vertical}this._update()},TempusDominusBootstrap4.prototype.widgetParent=function(_widgetParent){if(arguments.length===0)return this._options.widgetParent;if(typeof _widgetParent=="string"&&(_widgetParent=$(_widgetParent)),_widgetParent!==null&&typeof _widgetParent!="string"&&!(_widgetParent instanceof $))throw new TypeError("widgetParent() expects a string or a jQuery object parameter");this._options.widgetParent=_widgetParent;this.widget&&(this.hide(),this.show())},TempusDominusBootstrap4._jQueryHandleThis=function(me,option,argument){var data=$(me).data(DateTimePicker.DATA_KEY);if((typeof option=="undefined"?"undefined":_typeof(option))==="object"&&$.extend({},DateTimePicker.Default,option),data||(data=new TempusDominusBootstrap4($(me),option),$(me).data(DateTimePicker.DATA_KEY,data)),typeof option=="string"){if(data[option]===undefined)throw new Error('No method named "'+option+'"');return argument===undefined?data[option]():data[option](argument)}},TempusDominusBootstrap4._jQueryInterface=function(option,argument){return this.length===1?TempusDominusBootstrap4._jQueryHandleThis(this[0],option,argument):this.each(function(){TempusDominusBootstrap4._jQueryHandleThis(this,option,argument)})},TempusDominusBootstrap4}(DateTimePicker);$(document).on(DateTimePicker.Event.CLICK_DATA_API,DateTimePicker.Selector.DATA_TOGGLE,function(){var $target=getSelectorFromElement($(this));$target.length!==0&&TempusDominusBootstrap4._jQueryInterface.call($target,"toggle")}).on(DateTimePicker.Event.CHANGE,"."+DateTimePicker.ClassName.INPUT,function(event){var $target=getSelectorFromElement($(this));$target.length!==0&&TempusDominusBootstrap4._jQueryInterface.call($target,"_change",event)}).on(DateTimePicker.Event.BLUR,"."+DateTimePicker.ClassName.INPUT,function(event){var $target=getSelectorFromElement($(this)),config=$target.data(DateTimePicker.DATA_KEY);$target.length!==0&&(config._options.debug||window.debug||TempusDominusBootstrap4._jQueryInterface.call($target,"hide",event))}).on(DateTimePicker.Event.KEYDOWN,"."+DateTimePicker.ClassName.INPUT,function(event){var $target=getSelectorFromElement($(this));$target.length!==0&&TempusDominusBootstrap4._jQueryInterface.call($target,"_keydown",event)}).on(DateTimePicker.Event.KEYUP,"."+DateTimePicker.ClassName.INPUT,function(event){var $target=getSelectorFromElement($(this));$target.length!==0&&TempusDominusBootstrap4._jQueryInterface.call($target,"_keyup",event)}).on(DateTimePicker.Event.FOCUS,"."+DateTimePicker.ClassName.INPUT,function(event){var $target=getSelectorFromElement($(this)),config=$target.data(DateTimePicker.DATA_KEY);$target.length!==0&&config._options.allowInputToggle&&TempusDominusBootstrap4._jQueryInterface.call($target,"show",event)});return $.fn[DateTimePicker.NAME]=TempusDominusBootstrap4._jQueryInterface,$.fn[DateTimePicker.NAME].Constructor=TempusDominusBootstrap4,$.fn[DateTimePicker.NAME].noConflict=function(){return $.fn[DateTimePicker.NAME]=JQUERY_NO_CONFLICT,TempusDominusBootstrap4._jQueryInterface},TempusDominusBootstrap4}(jQuery)}();