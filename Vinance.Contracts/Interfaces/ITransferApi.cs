...
namespace Vinance.Contracts.Interfaces
{
    ...
    {
        Task<PagedList<Transfer>> GetAll(int? accountId, TransferType? transferType, DateTime? from = null, DateTime? to = null, int? page = null, int? pageSize = null, string order = null);
